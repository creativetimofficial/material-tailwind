export default function SectionNavbar3() {
  return (
    <nav className="navbar w-full bg-white rounded-none my-5 py-4">
      <div className="container mx-auto lg:flex">
        <div className="flex items-center justify-between">
          ...
          <button className="button button-pink button-sm hidden lg:inline-block" type="button">Buy Now</button>
      </div>
    </nav>
  )
}