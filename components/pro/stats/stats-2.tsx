export default function SectionStats2() {
  return (
    <div className="my-20">
      <div className="container lg:flex mx-auto">
        <img
          src="https://images.unsplash.com/photo-1618211535056-e678b388af32?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1365&q=80"
          alt="testimonials2"
          className="w-10/12 lg:w-2/5 mx-8 md:mx-0 object-cover rounded-2xl shadow-xl"
        />
