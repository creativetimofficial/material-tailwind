export default function SectionLogoArea1() {
  return (
    <div className="my-20">
      <p className="text-xl text-grey-700 font-normal text-center">Join 4,000 + companies already growing</p>
      <div className="container mx-auto grid grid-cols-2 items-start gap-y-12 gap-x-8 p-8 md:grid-cols-3 lg:grid-cols-6">
