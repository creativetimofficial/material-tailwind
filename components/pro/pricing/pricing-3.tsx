      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 p-4">
          <div className="hidden lg:block">
            <h4 className="antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-grey-900 flex items-center gap-3 py-4">
              &nbsp;
            </h4>
          ...
          <div className="">
            ...
            <div className="flex items-end gap-1 mb-4">
              <h1 className="antialiased tracking-normal font-sans text-5xl font-semibold leading-tight text-blue-grey-900">
                $10
              </h1>
              <p className="antialiased text-base leading-relaxed text-grey-700 font-medium mb-2">
                per month
              </p>
            </div>
            <p className="antialiased text-base leading-relaxed text-grey-700 font-normal mb-8 opacity-80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-x-16 p-4">
          <div className="py-2">
            <p className="antialiased text-base leading-relaxed text-pink-500 font-medium">
              Overview
            </p>
          </div>
        </div>
        <div className="overflow-x-scroll">
          <div className="grid min-w-[64rem] grid-cols-4 gap-x-16 p-4 bg-blue-grey-50/30">
            <div className="flex items-center gap-1.5">
              <p className="antialiased text-base leading-relaxed text-blue-grey-900 font-medium">
                Basic features
              </p>
              <svg
          ...
          <div className="grid min-w-[64rem] grid-cols-4 gap-x-16 p-4 text-center">
            ...
            <p className="antialiased text-base leading-relaxed text-grey-700 opacity-80 font-normal">
              10
            </p>
            <p className="antialiased text-base leading-relaxed text-grey-700 opacity-80 font-normal">
              20
          ...
          <div className="grid min-w-[64rem] grid-cols-4 gap-x-16 p-4 text-center bg-blue-grey-50/30">
            ...
            <p className="antialiased text-base leading-relaxed text-grey-700 opacity-80 font-bold">
              ⎯
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-x-16 py-8 px-4">
            <div className="py-2">
              <a
                href="#"
                className="antialiased text-base leading-relaxed text-pink-500 font-medium hover:text-pink-700 transition-colors"
              >
