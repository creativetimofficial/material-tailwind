      ...
      <div className="container mx-auto grid h-full items-center lg:grid-cols-2">
        <div className="text-center lg:text-left">
          <div className="mb-8 inline-flex items-center rounded-full bg-pink-50 py-1 pl-1 pr-3">
            <p className="antialiased text-sm leading-normal mr-3 rounded-full bg-white py-0.5 px-3 font-semibold text-pink-500">New</p>
            <p className="antialiased text-sm leading-normal text-pink-500 flex items-center font-semibold">Personalized coaching in-app
          ...
          <h1 className="antialiased tracking-normal font-sans text-5xl font-semibold text-blue-gray-900 mb-8 leading-tight lg:text-6xl">Portfolio perfromance tracking made easy</h1>
          <p className="antialiased text-xl font-normal leading-relaxed text-gray-700 lg:pr-20">Designed by marketers, for marketers. Untitled gives you the guidance, data and innovation you need to become a better marketer.</p>
