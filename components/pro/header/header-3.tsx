  ...
  return (
    <header className="h-full min-h-screen w-screen bg-white pt-28 md:pt-32 lg:px-8 lg:pt-40">
      <div className="container mx-auto grid h-full items-center text-center">
        ...
        <p className="text-xl font-normal leading-relaxed text-grey-700 mx-auto mb-12 w-full px-8 lg:w-10/12 lg:px-12 xl:w-8/12 xl:px-20">Mo money, no problems. Material is a next-generation financial technology company in the process of reinventing banking. 30-day free trial.</p>
