  ...
  return (
    <header className="h-full min-h-screen w-screen bg-white px-4 pt-20 lg:px-8 lg:pt-24">
      <div className="container mx-auto grid h-full place-items-center rounded-3xl bg-gradient-to-tr from-pink-700 to-pink-500 px-12 pt-24 pb-48 text-center">
        <h1 className="tracking-normal font-sans text-5xl font-semibold leading-tight text-white mb-8 leading-tight lg:text-7xl">Your Desired<br/> 
          <span className="opacity-75">Experiences</span>
        </h1>
        <p className="text-xl font-normal leading-relaxed text-white mb-16 w-full opacity-75 md:w-10/12 lg:w-7/12">We’re constantly trying to express ourselves and actualize our dreams. If you have the opportunity to play this game.</p>
