...
export function useActionKey() {
  let [actionKey, setActionKey] = React.useState<string[]>();
...
export function SearchProvider({ children }) {
  ...
  return (
    <>
      <Head>
        <link rel="preconnect" href={`https://${APP_ID}-dsn.algolia.net`} crossOrigin="" />
      </Head>
...
export function SearchButton({ children, ...props }) {
  let searchButtonRef = React.useRef();
  let actionKey = useActionKey();
  let { onOpen, onInput } = React.useContext(SearchContext);
