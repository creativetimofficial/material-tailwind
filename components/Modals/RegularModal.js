...
export default function RegularModal() {
  ...
  return (
    <>
      <button
        className="text-white font-normal px-6 py-2 rounded outline-none focus:outline-none mr-1 mb-1 bg-teal-500"
        type="button"
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded shadow-sm relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-gray-300 rounded-b">
                  <button
                    className="text-white font-normal px-6 py-2 rounded outline-none focus:outline-none mr-1 mb-1 bg-red-500"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                    Close
