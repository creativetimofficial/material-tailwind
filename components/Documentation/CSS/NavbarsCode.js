...
const iconsText = [
  ["fab fa-facebook-square", "Share"],
  ["fab fa-twitter", "Tweet"],
  ["fab fa-pinterest", "Pin"]
];

const iconsTextSearch = [
  ["fab fa-facebook-square", null],
  ["fab fa-twitter", "Tweet"],
  [null, "Settings"]
];
      ...
      case "icons":
        links = icons.map((prop, key) => {
          ...
          <a ` +
            ...
            `="` +
            prop +
            ` text-lg leading-lg text-white opacity-75" />
          </a>
        </li>\n`;
          return (
            <li className="nav-item" key={key}>
              ...
              >
                <i
                  className={prop + " text-lg leading-lg text-white opacity-75"}
                />
              </a>
            </li>
          );
      ...
      case "icons-text":
        links = iconsText.map((prop, key) => {
          ...
          <a ` +
            ...
            `="` +
            prop[0] +
            ` text-lg leading-lg text-white opacity-75" /><span ` +
            (this.state.type !== "react" ? "class" : "className") +
            `="ml-2">` +
            prop[1] +
            `</span>
          ...
          return (
            <li className="nav-item" key={key}>
              ...
              >
                <i
                  className={
                    prop[0] + " text-lg leading-lg text-white opacity-75"
                  }
                />{" "}
