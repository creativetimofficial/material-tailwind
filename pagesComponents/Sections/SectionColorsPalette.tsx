        ...
        <div className="w-full md:w-6/12 px-4 relative order-first md:order-last">
          <div className="lg:w-2/3 md:ml-7 lg:ml-24">
            ...
            <Typography className="text-lg lg:pr-2 text-[#1A237E]/60">
              Create a color theme that perfectly matches your style and brand, inspired by <a href="https://material.io/design/color/the-color-system.html#tools-for-picking-colors" target="_blank">Material Design</a>. Get color inspiration for your designs with Material Tailwind!
            </Typography>
          </div>
        </div>
      </div>
