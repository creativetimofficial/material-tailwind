...
export default function RegularOutline() {
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/buttons/regular/outline"
        />
        {/* Open Graph data */}
        <meta
          property="og:url"
          content="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/buttons/regular/outline"
        />
        <title>Outline Buttons | Tailwind Starter Kit by Creative Tim</title>
      </Head>
      <Navbar fixed />
      <div className="container mx-auto mt-4 pt-12">
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-9/12 lg:w-8/12 px-4 sm:pr-10 lg:pr-4">
            <div className="my-8">
              <Heading
                title="Regular Outline Buttons"
                description="Regular outline buttons in different styles and colors can be used for call to actions in forms and more."
              />
              <SmallHeading
                title="Only Text"
              ...
              <ButtonsCode
                ...
                buttonType="text-sm px-6 py-3 rounded"
                buttonText="Regular"
                icon={false}
                outline
              />
              ...
              <ButtonsCode
                ...
                buttonType="text-sm px-6 py-3  rounded-full"
                buttonText="Regular"
                icon={false}
                outline
              />
