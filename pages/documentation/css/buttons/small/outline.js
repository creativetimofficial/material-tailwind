...
export default function SmallOutline() {
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/buttons/small/outline"
        />
        {/* Open Graph data */}
        <meta
          property="og:url"
          content="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/buttons/small/outline"
        />
        <title>
          Small Outline Buttons | Tailwind Starter Kit by Creative Tim
        </title>
      </Head>
      <Navbar fixed />
      <div className="container mx-auto mt-4 pt-12">
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-9/12 lg:w-8/12 px-4 sm:pr-10 lg:pr-4">
            <div className="my-8">
              <Heading
                title="Small Outline Buttons"
                description="Small outline buttons in different styles and colors can be used for call to actions in forms and more."
              />
              <SmallHeading
                title="Only Text"
              ...
              <ButtonsCode
                ...
                buttonType="text-xs px-4 py-2 rounded"
                buttonText="Small"
                icon={false}
                outline
              />
              ...
              <ButtonsCode
                ...
                buttonType="text-xs px-4 py-2 rounded-full"
                buttonText="Small"
                icon={false}
                outline
              />
