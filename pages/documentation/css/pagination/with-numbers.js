  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/pagination/with-numbers"
        />
        {/* Open Graph data */}
        <meta
          property="og:url"
          content="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/pagination/with-numbers"
        />
        <title>CSS Pagination | Tailwind Starter Kit by Creative Tim</title>
      </Head>
      <Navbar fixed />
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-9/12 lg:w-8/12 px-4 sm:pr-10 lg:pr-4">
            <div className="my-8">
              <Heading
                title="Pagination"
                description="Check out our pagination examples with number. Don't forget to choose your color."
              />
              <SmallHeading
                title="Simple"
                description="The following example only showcases some numbered pagination."
              />
              <PaginationsCode
