...
import AlertsCode from 'components/Documentation/CSS/AlertsCode.js';
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/alerts"
        />
        {/* Open Graph data */}
        <meta
          property="og:url"
          content="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/css/alerts"
        />
        <title>CSS Alerts | Tailwind Starter Kit by Creative Tim</title>
      </Head>
      <Navbar fixed />
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-9/12 lg:w-8/12 px-4 sm:pr-10 lg:pr-4">
            <div className="my-8">
              <Heading
                title="Alerts"
                description="Elements that provide contextual feedback messages for user actions.
          The notification is a simple colored block meant to draw the
          attention to the user about something."
              />
              <div className="mb-8">
                <SmallHeading
