  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/react/tooltips/left"
        />
        {/* Open Graph data */}
        <meta
          property="og:url"
          content="https://www.creative-tim.com/learning-lab/tailwind-starter-kit/documentation/react/tooltips/left"
        />
        <title>
      ...
      <div className="container mx-auto mt-4 pt-12">
        <div className="flex flex-wrap">
          ...
          <div className="w-full sm:w-9/12 lg:w-8/12 px-4 sm:pr-10 lg:pr-4">
            <div className="my-8">
              <Heading
                title="React left tooltips"
                description="React pop over component that appears to the left of a button on user hover."
              />
              <SmallHeading
                title="Examples"
                description={
