...
```html
 <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
  <table class="w-full text-left table-auto min-w-max">
    <thead>
      <tr>
        <th class="p-4 border-b border-slate-100 bg-slate-50">
          <p class="block text-sm font-normal leading-none text-slate-800 opacity-70">
            Name
          </p>
        </th>
        <th class="p-4 border-b border-slate-100 bg-slate-50">
        ...
        <th class="p-4 border-b border-slate-100 bg-slate-50">
          <p class="block text-sm font-normal leading-none text-slate-800 opacity-70"></p>
        </th>
      </tr>
    </thead>
    <tbody>
