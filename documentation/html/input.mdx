...
<ComponentCard id="input-outline">
  <div className="w-1/2 input-group input-group-outline">
...
<ComponentCard id="input-dynamic">
  <div className="w-1/2 input-group input-group-dynamic">
...
<ComponentCard id="input-static">
  <div className="w-1/2 input-group input-group-static">
    <label>Static</label>
    <input type="text" className="form-control" />
  </div>
</ComponentCard>
