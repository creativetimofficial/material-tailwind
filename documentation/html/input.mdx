...
<div class="w-full max-w-sm min-w-[200px] mt-4">
  ...
  <input
    type="text"
    class="w-full h-10 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
...
<div class="w-full max-w-sm min-w-[200px] relative mt-4">
  ...
  <div class="relative">
    <input
      class="w-full pl-11 h-10 pr-3 py-2 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
      placeholder="Enter your text"
    />
    <button
      class="absolute h-8 w-8 left-1 top-1 my-auto px-2 flex items-center bg-neutral-800 rounded hover:bg-neutral-700"
      type="button"
    >
...
<div class="w-full max-w-sm min-w-[200px] relative mt-4">
  ...
  <div class="relative">
    <input
      class="w-full pr-11 h-10 pl-3 py-2 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
      placeholder="Enter your text"
    />
    <button
      class="absolute h-8 w-8 right-1 top-1 my-auto px-2 flex items-center bg-neutral-800 rounded hover:bg-neutral-700"
      type="button"
    >
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FFF" class="w-8 h-8">
        <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
...
<div class="w-full max-w-sm min-w-[200px] relative mt-4">
  ...
  <div class="relative">
    <input
      class="w-full pl-20 h-10 pr-3 py-2 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
      placeholder="Enter your text"
    />
    <button
      class="absolute h-8 text-white text-sm left-1 top-1 my-auto px-3 flex items-center bg-neutral-800 rounded hover:bg-neutral-700"
      type="button"
    >
      Search
    </button>
...
<div class="w-full max-w-sm min-w-[200px] relative mt-4">
  ...
  <div class="relative">
    <input
      class="w-full pr-20 h-10 pl-3 py-2 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
      placeholder="Enter your text"
    />
    <button
      class="absolute h-8 text-white text-sm right-1 top-1 my-auto px-3 flex items-center bg-neutral-800 rounded hover:bg-neutral-700"
      type="button"
    >
      Search
    </button>
...
<div class="w-full max-w-sm min-w-[200px] mt-4 ">
  ...
  <div class="relative mt-2">
      ...
      <button id="dropdownButton" class="h-full text-sm flex justify-center items-center bg-transparent text-neutral-700 focus:outline-none">
        Dropdown
      ...
      <div class="h-6 border-l border-neutral-200 ml-2"></div>
      <div id="dropdownMenu" class="min-w-[150px] overflow-hidden absolute left-0 w-full mt-10 hidden w-full bg-white border border-neutral-200 rounded-md shadow-lg z-10">
        <ul id="dropdownOptions">
          <li class="px-4 py-2 hover:bg-neutral-100 text-sm cursor-pointer">Dropdown 1</li>
          <li class="px-4 py-2 hover:bg-neutral-100 text-sm cursor-pointer">Dropdown 2</li>
          <li class="px-4 py-2 hover:bg-neutral-100 text-sm cursor-pointer">Dropdown 3</li>
        </ul>
      </div>
    </div>
    <input
      type="text"
      class="w-full h-10 pl-32 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
      placeholder="Enter your text" />
  </div>   
</div>
...
<div class="w-full max-w-sm min-w-[200px] mt-4 relative">
  ...
  <div class="relative mt-2">
    ...
    <div class="h-6 border-l border-neutral-200 mr-3"></div>
            <button id="dropdownButton2" class="h-full text-sm flex justify-center items-center bg-transparent text-neutral-700 focus:outline-none">
      Dropdown
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4 ml-1">
        <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
      </svg>
    </button>
    <div id="dropdownMenu2" class="min-w-[150px] overflow-hidden absolute left-0 w-full mt-10 hidden w-full bg-white border border-neutral-200 rounded-md shadow-lg z-10">
  ...
  <input
    type="text"
    class="w-full h-10 pr-32 bg-transparent text-neutral-700 text-sm border border-neutral-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-neutral-400 hover:border-neutral-400 shadow-sm focus:shadow-md"
    placeholder="Enter your text" />
  </div>
</div>
