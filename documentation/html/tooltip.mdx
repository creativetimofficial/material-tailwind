...
You can initialize a new tooltip by adding the <Code html>data-tooltip-target="`{tooltipName}`"</Code> data attribute to the trigger element and the <Code html>data-tooltip="`{tooltipName}`"</Code> to the element that you want to use as the tooltip.
...
You can change the position of the tooltip relative to it's trigger element by adding the <Code html>data-tooltip-placement="`{top}`"</Code> data attribute to the tooltip element by default it set's to <Code html>top</Code>. <br /> Check the placement values for tooltip <a className="hover:text-pink-500 font-medium" href="#tooltip-data-attributes">here</a>.
  ...
  component={
    <>
      <div className="mb-3 flex gap-3">
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-top-start"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Top Start`}
        </button>
        <div
          data-tooltip="tooltip-top-start"
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-top-end"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Top End`}
        </button>
        <div
          data-tooltip="tooltip-top-end"
      ...
      <div className="mb-3 flex gap-3">
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-right-end"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Right End`}
        </button>
      ...
      <div className="mb-3 flex gap-3">
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-bottom-start"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Bottom Start`}
        </button>
        <div
          data-tooltip="tooltip-bottom-start"
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-bottom-end"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Bottom End`}
        </button>
        <div
          data-tooltip="tooltip-bottom-end"
      ...
      <div className="mb-3 flex gap-3">
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-left-start"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Left Start`}
        </button>
        <div
          data-tooltip="tooltip-left-start"
        ...
        <button
          data-ripple-light="true"
          data-tooltip-target="tooltip-left-end"
          className="middle none center rounded-lg bg-gradient-to-tr from-pink-600 to-pink-400 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          {`Left End`}
        </button>
        <div
          data-tooltip="tooltip-left-end"
...
| `data-tooltip-placement`  | Set the position of the tooltip relative to it's trigger element.                   | <Code html>top</Code>                                                    |
| `data-tooltip-mount`      | Set the classnaes that should be used when the <br /> tooltip is visible.           | <Code html>opacity-1</Code>                                              |
| `data-tooltip-unmount`    | Set the classnaes that should be used when the <br /> tooltip is hidden.            | <Code html>opacity-0</Code><br /><Code html>pointer-events-none</Code>   |
| `data-tooltip-transition` | Set the classnaes that should be used for <br /> transition of the tooltip.         | <Code html>transition-opacity</Code><br /><Code html>duration-300</Code> |
...
```html
<!-- from node_modules -->
<script src="node_modules/@material-tailwind/html@latest/scripts/tooltip.js"></script>
