...
<CodePreview
  ...
  component={
    <div className="my-10 w-1/2">
      <div className="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
        <div className="translate-y-0 mx-4 -mt-6">
        ...
        <div className="p-6 flex-1 text-secondary">
          <a href="#">
...
>
  ```html
  <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
    <div class="translate-y-0 mx-4 -mt-6">
      <a href="#" blur-shadow-image="true">
        <img
    ...
    <div class="p-6 flex-1 text-secondary">
      <a href="#">
...
<CodePreview
  ...
  component={
    <div className="my-10 w-1/2">
      <div className="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
        <div className="translate-y-0 mx-4 mt-4">
          <a href="#" blur-shadow-image="true">
            <img
              className="w-auto rounded-lg"
        ...
        <div className="p-6 pt-0 bg-transparent">
          <div className="flex">
            <a href="#" className="inline-flex h-10 w-10">
              <img className="h-full w-full rounded-xl" src="https://demos.creative-tim.com/material-kit-pro/assets/img/marie.jpg" alt="avatar" />
            </a>
            <div className="ml-3">
              <span className="text-blue-gray-700 mb-0 font-bold">Mathew</span>
...
>
  ```html
  <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
    <div class="translate-y-0 mx-4 mt-4">
      <a href="#" blur-shadow-image="true">
        <img
          class="w-auto rounded-lg"
          src="https://demos.creative-tim.com/material-kit-pro/assets/img/annie-spratt.jpg"
    ...
    <div class="p-6 pt-0 bg-transparent">
      <div class="flex">
        <a href="#" class="inline-flex h-10 w-10">
          <img class="h-full w-full rounded-xl" src="https://demos.creative-tim.com/material-kit-pro/assets/img/marie.jpg" alt="avatar" />
        </a>
        <div class="ml-3">
          <span class="text-blue-gray-700 mb-0 font-bold">Mathew</span>
    ...
    <div className="my-10 w-1/2">
      <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
        ...
        <div className="p-6 flex-1 text-secondary">
          ...
          <button className="middle none center rounded-lg bg-pink-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none w-full" data-ripple-light="true">Sign In</button>
          <a href="#">
            <p className="mt-5 mb-0 text-center text-sm">Don&apos;t have an account?</p>
          </a>
        </div>
      </div>
    </div>
...
>
  ...
  <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
    ...
    <div class="p-6 flex-1 text-secondary">
      ...
      <button class="middle none center rounded-lg bg-pink-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" data-ripple-light="true">Sign In</button>
      <a href="#">
...
<CodePreview
  ...
  component={
    <div className="my-10">
      <div className="flex flex-col bg-white bg-clip-border rounded-xl shadow-none bg-transparent">
        <div className="flex">
          <div className="w-1/3">
            <img
          ...
          <div className="p-6 flex-1 text-secondary w-2/3">
...
>
  ```html
    <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-none bg-transparent">
      <div class="flex">
        <div class="w-1/3">
          <img
            class="rounded-lg"
        ...
        <div class="p-6 flex-1 text-secondary w-2/3">
