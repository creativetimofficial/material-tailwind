...
This card example features multiple tabs with content; this allows users to switch between different sections within the same card. It's perfect for organizing related information in a compact space.
