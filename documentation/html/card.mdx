  ...
  <TabPanel value={2}>
    ...
    <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
      ...
      <div class="p-6 flex-1 text-secondary">
        ...
        <button class="relative inline-block cursor-pointer py-2.5 px-6 overflow-hidden rounded-lg bg-pink text-white text-xs font-medium uppercase mr-3" data-ripple-light="true">Read More</button>
      </div>
    </div>
    ```
  </TabPanel>
  ...
  <TabPanel value={2}>
    ...
    <div class="flex flex-col bg-white bg-clip-border rounded-xl shadow-card">
      ...
      <div class="p-6 flex-1 text-secondary">
        ...
        <button class="relative inline-block cursor-pointer py-2.5 px-6 w-full overflow-hidden rounded-lg bg-pink text-white text-xs font-medium uppercase mr-3" data-ripple-light="true">Sign In</button>
        <a href="#">
          <p class="mt-5 mb-0 text-center text-sm">Don&apos;t have an account?</p>
        </a>
      </div>
