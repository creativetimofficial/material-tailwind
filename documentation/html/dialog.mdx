...
<ComponentPreview id="notification dialog">
  <button
...
<ComponentPreview id="message dialog">
  <button
...
<ComponentPreview id="long dialog">
  <button
...
<ComponentPreview id="signin dialog">
  <button
    className="button button-pink"
    dialog-trigger="true"
    data-ripple-light="true"
...
<ComponentPreview id="signup dialog">
  <button
