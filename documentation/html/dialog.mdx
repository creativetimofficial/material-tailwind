          ...
          >
            <div className="mb-6">
              ...
              <ul className="mt-1 -ml-2 flex flex-col gap-1">
                ...
                >
                  <img src="https://docs.material-tailwind.com/icons/metamask.svg" alt="metamast" className="h-6 w-6" />
                  <h6
...
>
  ...
  >
    ...
    <div
      class="relative p-4 pr-2 overflow-y-scroll font-sans text-base antialiased font-light leading-relaxed text-blue-gray-500"
    >
      <div class="mb-6">
        <p
          class="block font-sans text-sm antialiased font-semibold leading-normal text-gray-700 opacity-70"
        >
          Popular
        </p>
        <ul class="flex flex-col gap-1 mt-1 -ml-2">
          ...
          >
            <img src="https://docs.material-tailwind.com/icons/metamask.svg" alt="metamast" class="h-6 w-6" />
            <h6
    ...
    <div
      class="flex flex-wrap items-center justify-between gap-2 p-4 border-t shrink-0 text-blue-gray-500 border-blue-gray-50"
    >
      <p
      ...
      <button
        class="px-4 py-2 font-sans text-xs font-bold text-center text-pink-500 uppercase align-middle transition-all rounded-lg select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:bg-pink-500/10 active:bg-pink-500/30"
        type="button"
        data-ripple-dark="true"
      >
        Learn More
