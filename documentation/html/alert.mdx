...
<ComponentCard id="alert">
  <div className="alert alert-pink w-full mb-0">Alert primary</div>
</ComponentCard>
...
<ComponentCard id="simple-alert">
  ...
  <div className="alert alert-dark w-full mb-0">Alert Dark</div>
</ComponentCard>
...
<ComponentCard id="alert with gradient">
  ...
  <div className="alert alert-gradient alert-light text-dark-500 w-full">Alert Light</div>
  <div className="alert alert-gradient alert-dark w-full mb-0">Alert Dark</div>
</ComponentCard>
...
<div class="alert alert-gradient alert-light text-dark-500 w-full">Alert Light</div>
