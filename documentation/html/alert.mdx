...
<CodeTabs>
  ...
  <TabPanel value={2}>
    ```html
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-pink w-full">Alert primary</div>
    ```
  </TabPanel>
</CodeTabs>
...
<CodeTabs>
  ...
  <TabPanel value={2}>
    ```html
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-pink w-full">Alert primary</div>
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-secondary w-full">Alert secondary</div>
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-greeen w-full">Alert success</div>
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-red w-full">Alert danger</div>
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-deep-orange w-full">Alert warning</div>
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-blue w-full">Alert info</div>
    <div class="relative p-4 mb-4 rounded-md leading-5 opacity-100 bg-dark w-full">Alert dark</div>
    ```
  </TabPanel>
</CodeTabs>
