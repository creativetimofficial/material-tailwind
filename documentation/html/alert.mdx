...
>
```html
<div role="alert" class="mt-3 relative flex w-full p-4 text-sm text-white bg-slate-800 rounded-md">
  A simple filled alert for showing message.
  <button class="flex items-center justify-center transition-all w-8 h-8 rounded-md text-white hover:bg-white/10 active:bg-white/10 absolute top-2.5 right-2.5" type="button">
