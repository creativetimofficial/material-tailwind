...
navigation: ["chip", "chip-variants", "chip-colors", "chip-dismissible"]
github: chip
prev: checkbox
next: dialog
---
...
<CodePreview
  id="chip-dismissible"
  link="button#chip-dismissible"
  component={
    <div className="relative inline-block align-baseline font-sans text-xs font-bold uppercase center leading-none whitespace-nowrap py-2 px-3.5 rounded-lg select-none bg-gradient-to-tr from-pink-600 to-pink-400 text-white" data-dismiss>
      <div className="mr-5 mt-px">Dismissible</div>
      <div className="absolute top-1 right-1 mt-[0.5px] mx-px w-max rounded-md bg-pink-800 hover:bg-pink-900 transition-colors"
      >
        <div role="button" className="w-5 h-5 p-1">
...
>
  ```html
  <div class="relative inline-block align-baseline font-sans text-xs font-bold uppercase center leading-none whitespace-nowrap py-2 px-3.5 rounded-lg select-none bg-gradient-to-tr from-pink-600 to-pink-400 text-white" data-dismiss>
    <div class="mr-5 mt-px">Dismissible</div>
    <div class="absolute top-1 right-1 mt-[0.5px] mx-px w-max rounded-md bg-pink-800 hover:bg-pink-900 transition-colors"
    >
