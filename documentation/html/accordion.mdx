    ...
    <div className="accordion-item relative mb-3">
      <h6 className="mb-0">
        <button className="accordion-button font-semibold text-left" type="button" aria-expanded="false">
          ...
          <i className="collapse-close fa fa-plus text-xs pt-1 absolute right-0" aria-hidden="true"></i>
          <i className="collapse-open fa fa-minus text-xs pt-1 absolute right-0" aria-hidden="true"></i>
        </button>
      </h6>
    ...
    <div class="accordion-item relative mb-3">
      <h6 class="mb-0">
        <button class="accordion-button font-semibold text-left" type="button" aria-expanded="false">
          <span>How do I order?</span>
          <i class="collapse-close fa fa-plus text-xs pt-1 absolute right-0" aria-hidden="true"></i>
          <i class="collapse-open fa fa-minus text-xs pt-1 absolute right-0" aria-hidden="true"></i>
        </button>
      </h6>
