    ...
    <div class="accordion">
      ...
      <div class="accordion-item relative mb-3">
        <h6 class="accordion-header">
          <button
            class="accordion-button collapsed text-left font-semibold"
            type="button"
            aria-expanded="false"
          >
            <span>How can i make the payment?</span>
  ...
  <TabPanel value={2}>
    ...
    <div class="accordion">
      <div class="relative mb-3">
        <h6 class="mb-0">
          <button
            class="relative flex items-center w-full py-4 text-secondary-500 border-b border-grey-300 text-left font-semibold"
            type="button"
            aria-expanded="false"
          >
            <span>How do I order?</span>
      ...
      <div class="relative mb-3">
        <h6 class="mb-0">
          <button
            class="relative flex items-center w-full py-4 text-dark-500 border-b border-grey-300 collapsed text-left font-semibold"
            type="button"
            aria-expanded="false"
          >
            <span>How can i make the payment?</span>
