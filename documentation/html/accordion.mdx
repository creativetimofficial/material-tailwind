...
>
  ```html
  <div data-collapse="true">
    <div data-collapse-section="true" class="relative mb-3">
      <h6 class="mb-0">
        <button
          class="relative flex items-center w-full p-4 font-semibold text-dark-500 text-left transition-all border-b border-solid cursor-pointer border-slate-100 ease-in text-slate-700 rounded-t-1"
          type="button"
          aria-expanded="true"
          data-collapse-trigger="true"
        >
          <span>How do I order?</span>
          <i 
            class="fa fa-plus absolute right-0 pt-1 text-xs hidden"
            section-open-icon="true"
          ></i>
          <i 
            class="fa fa-minus absolute right-0 pt-1 text-xs"
            section-close-icon="true"
            ></i>
        </button>
      </h6>
      <div data-collapse-content="true" class="overflow-hidden transition-all ease-in-out duration-300">
        <div class="p-4 leading-normal text-sm text-blue-gray-500/80">
          We're not always in the position that we want to be at. We're constantly
          growing. We're constantly making mistakes. We're constantly trying to
          express ourselves and actualize our dreams. If you have the opportunity
          to play this game of life you need to appreciate every moment. A lot of
    ...
    <div data-collapse-section="true" class="relative mb-3">
      <h6 class="mb-0">
        ...
        >
          <span>How can i make the payment?</span>
          <i 
            class="fa fa-plus absolute right-0 pt-1 text-xs"
            section-open-icon="true"
          ></i>
          <i 
            class="fa fa-minus absolute right-0 pt-1 text-xs hidden"
            section-close-icon="true"
            ></i>
        </button>
      </h6>
...
You can modify the open/close state icon for Accordion component.

<CodePreview
  id="accordion-with-icon"
  link="button#accordion-with-icon"
  component={
    <div data-collapse="true">
      <div data-collapse-section="true" className="relative mb-3">
        <h6 className="mb-0">
          ...
          >
            ...
            <i 
              className="fas fa-chevron-down absolute right-0 pt-1 text-xs hidden"
              section-open-icon="true"
            ></i>
            <i 
              className="fas fa-chevron-up absolute right-0 pt-1 text-xs"
              section-close-icon="true"
              ></i>
          </button>
        </h6>
