...
navigation: ["footer", "footer-with-logo", "footer-with-social-links", "footer-with-sitemap", "best-practices"]
github: footer
prev: typography
next: image
---
...
Use this footer example if you are looking for a more complex and information-rich layout. It utilizes a grid system for organization and offers a variety of links and resources. It also includes social media icons that are styled to blend with the footer's design, featuring hover effects (<Code>hover:opacity-100</Code>) that encourage interaction.
