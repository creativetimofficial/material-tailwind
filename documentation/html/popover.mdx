...
>
  ...
  >
    <div className="mb-2 flex items-center justify-between gap-4">
      ...
      />
      <button
        className="select-none rounded-lg bg-gradient-to-tr from-blue-600 to-blue-400 py-2 px-4 text-center align-middle font-sans text-xs font-medium capitalize text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="button"
        data-ripple-light="true"
      >
        Follow
