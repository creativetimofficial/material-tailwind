...
You just need to modify the <Code html>colors</Code> object for the <Code html>tailwind.config.js</Code> file.
...
You just need to add your own color to the <Code html>extend</Code> and <Code html>colors</Code> object for <Code html>tailwind.config.js</Code> file.

```js showLineNumbers {5-16}
module.exports = withMT({
  theme: {
    extend: {
      colors: {
...
For more information about tailwindcss colors customization, please check the <a href="https://tailwindcss.com/docs/customizing-colors?ref=material-tailwind" target="_blank" className="font-medium hover:text-pink-500 transition-colors">TailwindCSS Documentation</a>
