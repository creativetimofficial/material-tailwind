...
You can use any type of icons inside the button, in the below example we've used the <a href="https://heroicons.com/?ref=material-tailwind" target="_blank" class="font-medium transition-colors hover:text-pink-500">@heroicons</a>.
...
You can use tailwind css <Code html>rounded-full</Code> class with Button to create rounded buttons.
...
You can wrap <Code html>Button</Code> component with <Code html>{`<a>`}</Code> tag to make it a link.
