...
>
  ...
  <button
    ...
    data-ripple-dark="true"
  >
    <img src="/icons/metamask.svg" alt="metamask" class="w-6 h-6" />
    Connect Wallet
  </button>
  <button
    ...
    data-ripple-dark="true"
  >
    <img src="/icons/google.svg" alt="metamask" class="w-6 h-6" />
    Continue with Google
  </button>
  <button
  ...
  >
    ...
    <span class="absolute right-0 grid w-12 h-full transition-colors place-items-center bg-light-blue-600 group-hover:bg-light-blue-700">
      <img src="/icons/twitter.svg" alt="metamask" class="w-6 h-6" />
    </span>
  </button>
  ```
</CodePreview>
