...
navigation: ["avatar", "avatar-variants", "avatar-sizes", "avatar-with-border", "avatar-with-text", "avatar-stack", "avatar-with-dot-indicator", "avatar-with-dropdown", "best-practice"]
github: avatar
prev: alert
next: badge
---
