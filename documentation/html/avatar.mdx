...
navigation: ["avatar", "avatar-variants", "avatar-sizes", "avatar-stack", "best-practice"]
github: avatar
prev: alert
next: badge
---
...
## Default Avatar
Use our default exemple of placeholder for user profiles with Tailwind CSS classes for a responsive and rounded design.
