    ...
    <nav>
      <ul role="tablist" className="tabs p-1">
        <li className="nav-item">
          <a className="active nav-link mb-0 px-0 py-1" aria-selected="true">
            {`My Profile`}
          </a>
        </li>
        <li className="nav-item">
      ...
      <ul role="tablist" className="tabs p-1">
        <li className="nav-item">
          <a
            ...
            role="tab"
          >
            <i className="material-icons mr-2 text-sm">person</i>
            {`My Profile`}
          </a>
        </li>
        <li className="nav-item">
          <a
            ...
            role="tab"
          >
            <i className="material-icons mr-2 text-sm">dashboard</i>
            {`Dashboard`}
          </a>
        </li>
      </ul>
