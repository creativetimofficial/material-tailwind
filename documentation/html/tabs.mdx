      ...
      <div className="relative right-0">
        ...
        >
          <li className="z-30 flex-auto text-center">
            <a
              className="ease-in-out text-slate-700 z-30 mb-0 flex items-center justify-center w-full rounded-lg border-0 bg-inherit px-0 py-1 transition-all cursor-pointer cursor-pointer"
              data-tab-target=""
              active
              role="tab"
              aria-selected="true"
          ...
          <li className="z-30 flex-auto text-center">
            <a
              className="ease-in-out text-slate-700 z-30 mb-0 flex items-center justify-center w-full rounded-lg border-0 bg-inherit px-0 py-1 transition-all cursor-pointer"
              data-tab-target=""
              role="tab"
              aria-selected="false"
            >
    ...
    <div class="relative right-0">
      ...
      >
        <li class="z-30 flex-auto text-center">
          <a
            class="ease-in-out text-slate-700 z-30 mb-0 flex items-center justify-center w-full rounded-lg border-0 bg-inherit px-0 py-1 transition-all cursor-pointer cursor-pointer"
            data-tab-target=""
            active
            role="tab"
            aria-selected="true"
        ...
        <li class="z-30 flex-auto text-center">
          <a
            class="ease-in-out text-slate-700 z-30 mb-0 flex items-center justify-center w-full rounded-lg border-0 bg-inherit px-0 py-1 transition-all cursor-pointer"
            data-tab-target=""
            role="tab"
            aria-selected="false"
          >
...
The <Code>Tabs</Code> component comes with different variants including icons.

<CodePreview
  id="tabs-icons"
  link="button#tabs-icons"
  component={
    <div className="w-2/3">
      <div className="relative right-0">
        <ul
      ...
      <div className="relative right-0">
        ...
        <div data-tab-content="" className="p-5">
          <div className="block opacity-100" id="app" role="tabpanel">
            <p className="block antialiased font-sans text-base font-light leading-relaxed text-inherit text-blue-gray-500">
    ...
    <div class="relative right-0">
      ...
      <div data-tab-content="" class="p-5">
        <div class="block opacity-100" id="app" role="tabpanel">
          <p class="block antialiased font-sans text-base font-light leading-relaxed text-inherit text-blue-gray-500">
            Because it's about motivating the doers. Because I'm here to follow my dreams and inspire other people to follow their dreams, too.
          </p>
        </div>
