...
<ComponentDemo id="tabs simple">
  <div className="w-1/2">
    <nav>
      <ul role="tablist" className="tabs p-1">
        <li className="nav-item">
          <a className="nav-link active mb-0 px-0 py-1" aria-selected="true">
            My Profile
          </a>
        </li>
        <li className="nav-item">
          <a className="nav-link mb-0 px-0 py-1" aria-selected="false">
            Dashboard
          </a>
        </li>
      </ul>
      ...
      <ul role="tablist" className="tabs p-1">
        <li className="nav-item">
          <a
            ...
            role="tab"
          >
            <i className="material-icons mr-2 text-sm">person</i>My Profile
          </a>
        </li>
        <li className="nav-item">
          <a
            ...
            role="tab"
          >
            <i className="material-icons mr-2 text-sm">dashboard</i>Dashboard
          </a>
        </li>
      </ul>
    </nav>
...
<div class="nav-tabs w-9/12">
  <nav>
    <ul role="tablist" class="tabs p-1" tab-panel="">
      <li class="nav-item">
        <a
          class="active nav-link mb-0 px-0 py-1"
          aria-selected="true"
          aria-controls="html"
          role="tab"
          >HTML</a
...
All you have to do is to set **.flex-col** class for the **_ul_**

<ComponentDemo id="vertical tabs">
  <div className="nav-tabs flex w-9/12">
    <div className="w-1/3">
      <nav>
        <ul role="tablist" className="tabs flex-col p-1" tab-panel="">
          <li className="nav-item">
            <a
              className="active nav-link mb-0 px-0 py-1"
              aria-selected="true"
              aria-controls="home"
              role="tab"
            >
    ...
    <div className="w-2/3">
      <div className="tabs-content p-5">
        <div className="active tab-panel" id="home" role="tabpanel">
          Because it's about motivating the doers. Because I'm here to follow my
          dreams and inspire other people to follow their dreams, too.
        </div>
        <div className="tab-panel" id="profile" role="tabpanel">
          The reading of all good books is like a conversation with the finest
          minds of past centuries.
        </div>
        <div className="tab-panel" id="messages" role="tabpanel">
          Comparing yourself to others is the thief of joy.
        </div>
        <div className="tab-panel" id="settings" role="tabpanel">
          It’s better to choose, commit, and get started instead of waiting for
          the best possible option.
        </div>
      </div>
