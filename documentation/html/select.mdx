...
<div className="w-1/3">
  <select className="form-control" name="choice-button" id="choice-button" placeholder="Language">
...
<ComponentCard id="select with search">
<div className="w-1/3">
  <select className="form-control" name="choice-search" id="choice-search" placeholder="Location">
    <option defaultValue="Choice 1" selected>Brazil</option>
    <option defaultValue="Choice 2">Bucharest</option>
    <option defaultValue="Choice 3">London</option>
    <option defaultValue="Choice 4">Washington</option>
...
```html showLineNumbers
<div class="w-1/6">
  <select class="form-control" name="choice-search" id="choice-search" placeholder="Location">
    <option defaultValue="Choice 1" selected>Brazil</option>
    <option defaultValue="Choice 2">Bucharest</option>
    <option defaultValue="Choice 3">London</option>
    <option defaultValue="Choice 4">Washington</option>
