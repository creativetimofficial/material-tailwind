...
The trigger element of the dropdown menu uses the <Link href="/docs/html/popover#popover-trigger-data-attributes" className="font-medium hover:text-blue-500">popover trigger data attribure</Link> to work.
