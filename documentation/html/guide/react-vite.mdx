---
title: Vite + React - Installation Guide
...
github: guide/react-vite
prev: installation
next: license
---

# Material Tailwind with Vite (React)

<span id="installation" className="scroll-mt-48" />
Learn how to setup and install @material-tailwind/html with Vite (React).
