---
title: Pheonix - Installation Guide
description: Learn how to use Material Tailwind components with Pheonix and Tailwind CSS to easily create elegant and flexible pages.
navigation:
  [
    "installation",
    "npm",
...
github: guide/pheonix
prev: installation
next: license
---

# Material Tailwind with Pheonix

<span id="installation" className="scroll-mt-48" />
Learn how to setup and install @material-tailwind/html with Pheonix.

<br />
<br />

First you need to create a new project using Pheonix, for more details check the <a target="_blank" className="font-medium hover:text-blue-500 transition-colors" href="https://hexdocs.pm/phoenix/installation.html?ref=material-tailwind">Pheonix Official Documentation</a>
