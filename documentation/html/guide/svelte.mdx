...
description: Learn how to use Material Tailwind components with Svelte and Tailwind CSS to easily create elegant and flexible pages.
navigation:
  [
    "installation",
    "npm",
...
First you need to create a new project using Svelte, for more details check the <a target="_blank" className="font-medium hover:text-blue-500 transition-colors" href="https://svelte.dev/docs/introduction?ref=material-tailwind">Svelte Official Documentation</a>
...
Check <a href="https://tailwindcss.com/docs/guides/sveltekit?ref=material-tailwind" target="_blank" className="font-medium hover:text-blue-500 transition-colors">Tailwind CSS Installation</a> for Svelte on Tailwind CSS Documentation.
