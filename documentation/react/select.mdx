...
<CodePreview id="select-variants" link="select#select-variants" component={
...
<CodePreview id="select-sizes" link="select#select-sizes" component={
  <div className="flex w-full items-end gap-4">
...
<CodePreview id="select-colors" link="select#select-colors" component={
...
<CodePreview id="select-validations" link="select#select-validations" component={
  <div className="flex w-full items-end gap-4">
...
<CodePreview id="custom-select-animation" link="select#custom-select-animation" component={
  <div className="w-72">
    <Select
...
<CodePreview id="disabled-select" link="select#disabled-select" component={
  <div className="w-72">
