...
First you need to create a new project using remix, for more details check the <a target="_blank" className="font-medium hover:text-blue-500 transition-colors" href="https://remix.run/docs/en/v1?ref=material-tailwind">Remix Official Documentation</a>
