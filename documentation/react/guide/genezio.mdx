...
```
<br />
For more details check the <a target="_blank" className="font-medium hover:text-blue-500 transition-colors" href="https://docs.genez.io/genezio-documentation/getting-started?ref=mt-docs">Genezio Official Documentation</a>
