...
> `@material-tailwind/react` is working with Tailwind CSS classes and you need to have Tailwind CSS installed on your project - [Tailwind CSS Installation](https://tailwindcss.com/docs/guides/create-react-app).
