...
<ComponentPreview id="typography">
  <Typography>
...
<ComponentPreview id="typography-variants">
...
<ComponentPreview id="typography-colors">
  <div className="flex flex-col gap-8 text-left">
...
<ComponentPreview id="typography-gradient-color">
