...
<CodePreview id="typography" link="typography#typography" component={
  <Typography>
...
<CodePreview id="typography-variants" link="typography#typography-variants" component={
...
The <Code>Typography</Code> component comes with 23 different colors that you can change it using the <Code>color</Code> prop, below there are some examples of the colors but you can check all of the them [here.](#props)
