...
• <Code>size="md"</Code>: This creates a medium-sized Textarea, labeled "Textarea Medium".
• <Code>size="lg"</Code>: This renders a large-sized Textarea, labeled "Textarea Large".
...
• <Code>color="gray"</Code>: This creates a Textarea with gray styling, labeled "Textarea Gray".
• <Code>color="blue-gray"</Code>: This Textarea has a blue-gray color, labeled "Textarea Purple".
• <Code>color="red"</Code>: This renders a red Textarea, labeled "Textarea Red".
• <Code>color="green"</Code>: This creates a green Textarea, labeled "Textarea Green".
