...
| ------------ | -------------------- | ----------------------------------- | ---------------------- |
| `variant`    | [Variant](#types)    | Change textarea variant             | <Code>outlined</Code>  |
| `size`       | [Size](#types)       | Change textarea size                | <Code>md</Code>        |
| `color`      | [Color](#types)      | Change textarea color               | <Code>blue</Code>      |
