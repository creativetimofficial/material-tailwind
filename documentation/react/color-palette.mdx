...
navigation:
  ["default-color-palette", "customize-color-palette", "add-new-color"]
...
<span id="customize-color-palette" className="scroll-mt-48" />
...
You just need to modify the colors object for the <Code>tailwind.config.js</Code> file.
...
<span id="add-new-color" className="scroll-mt-48" />
...
You just need to add your own color to the colors object for <Code>tailwind.config.js</Code> file.

```js showLineNumbers {4-15}
module.exports = {
  theme: {
    colors: {
      sky: {
