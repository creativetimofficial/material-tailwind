...
that we've added for the tabs component and you can use all the other native
props as well.
...
props that we've added for the tabs header component and you can use all
...
that we've added for the tabs body component and you can use all the other
...
that we've added for the tab panel component and you can use all the other
native props as well.
