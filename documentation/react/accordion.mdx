...
* <Code>mb-2</Code>: adds a margin-bottom of 2 units for spacing between accordion items.
* <Code>rounded-lg</Code>: applies large rounded corners to the accordion.
* <Code>border border-blue-gray-100</Code>: adds a light grayish-blue border.
