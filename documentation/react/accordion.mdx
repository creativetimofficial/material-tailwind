...
<DocsTitle href="accordion-nesting">
## Accordion Nesting
</DocsTitle>

An Accordion can be nested as well

<CodePreview link="accordion#accordion-nesting" component={<AccordionExamples.AccordionNesting />}>
```jsx
import React from "react";
import {
  Accordion,
