...
<CodePreview id="subscription-popover" link="popover#subscription-popover" className="mt-4" component={
  <Popover placement="bottom">
    <PopoverHandler>
...
<CodePreview id="contact-popover" link="popover#contact-popover" className="mt-4" component={
  <Popover placement="bottom">
    <PopoverHandler>
...
<CodePreview id="popover-with-image" link="popover#popover-with-image" className="mt-4" component={
  <Popover>
    <PopoverHandler>
...
export default function Example() {
  return (
    <Popover>
      ...
      <PopoverContent className="w-[28rem] p-0 overflow-hidden flex">
        <div className="p-4">
          <Typography color="blue-gray" className="font-medium mb-2">Material Tailwind</Typography>
          <Typography variant="small" color="gray" className="font-normal mb-4">
            Material Tailwind is an easy to use components library for Tailwind CSS and Material Design. It features multiple React and HTML components, all written with Tailwind CSS classes and Material Design guidelines.
