...
<CodePreview id="subscription-popover" className="mt-4" component={
  <Popover placement="bottom">
    <PopoverHandler>
...
<CodePreview id="contact-popover" className="mt-4" component={
  <Popover placement="bottom">
    <PopoverHandler>
...
<CodePreview id="popover-with-image" className="mt-4" component={
  <Popover>
    <PopoverHandler>
