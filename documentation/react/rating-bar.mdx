...
<CodePreview id="rating" link="rating#rating" component={<RatingExamples.DefaultRating />}>
```jsx
...
<CodePreview id="rating-colors" link="rating#rating-colors" component={<RatingExamples.RatingColors />}>
```jsx
import { Rating } from "@material-tailwind/react";
...
<CodePreview id="readonly-rating" link="rating#readonly-rating" component={<RatingExamples.ReadonlyRating />}>
```jsx
import { Rating } from "@material-tailwind/react";
...
<CodePreview id="custom-rating-icon" link="rating#custom-rating-icon" component={<RatingExamples.CustomRatingIcon />}>
```jsx
import { Rating } from "@material-tailwind/react";
...
<CodePreview id="rating-with-text" link="rating#rating-with-text" component={<RatingExamples.RatingWithText />}>
```jsx
...
<CodePreview id="rating-with-comment" link="rating#rating-with-comment" component={<RatingExamples.RatingWithComment />}>
```jsx
