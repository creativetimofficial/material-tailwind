...
<DocsTitle href="custom-tooltip-animation">
## Custom Tooltip Animation
</DocsTitle>
...
<CodePreview id="tooltip-with-helper-icon" component={
  <Tooltip content={
    <div className="w-80">
