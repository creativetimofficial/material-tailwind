...
The <Code>className</Code> prop overrides the tailwindcss classnames for a component and sometimes you need to use the <Code>!</Code> modifier before the tailwindcss classnames to mark the classname as <Code>important</Code> override it over ther other classnames.
