...
navigation: ["spinner", "spinner-sizes", "spinner-colors", "props", "theme"]
related:
  [
    {
      title: "Props",
...
<CodePreview id="spinner" link="spinner#spinner" component={<SpinnerExamples.DefaultSpinner />}>
```jsx
...
<CodePreview id="spinner-sizes" link="spinner#spinner-sizes" component={<SpinnerExamples.SpinnerSizes />}>
```jsx
import { Spinner } from "@material-tailwind/react";
...
<CodePreview id="spinner-colors" link="spinner#spinner-colors" component={<SpinnerExamples.SpinnerColors />}>
```jsx
import { Spinner } from "@material-tailwind/react";
