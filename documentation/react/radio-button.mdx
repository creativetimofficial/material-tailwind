...
navigation:
  [
    ...
    "radio-button-with-custom-styles",
    "props",
    "theme",
  ]
related:
...
<CodePreview id="radio-button-with-link" component={
...
<CodePreview id="radio-button-with-description" component={
...
<CodePreview id="radio-button-vertical-list-group" component={
  <Card>
    <List>
...
<CodePreview id="radio-button-horizontal-list-group" component={
...
<DocsTitle href="radio-button-with-custom-styles">
## Radio Button with Custom Styles
</DocsTitle>

You can use the <Code>className</Code> prop to add custom styles to the <Code>Radio</Code> component.

<CodePreview id="radio-button-with-custom-styles" component={
  <div className="flex gap-10">
    <Radio
      id="premium"
      name="type"
      ripple={false}
      icon={<SolidIcons.CheckCircleIcon className="w-full h-full scale-105" />}
      className="hover:before:opacity-0 bg-blue-500/25 border-blue-500/50 transition-all p-0"
      label={<Typography color="blue-gray" className="font-normal">Premium</Typography>}
    />
    <Radio
      id="free"
      name="type"
      ...
      icon={<SolidIcons.CheckCircleIcon className="w-full h-full scale-105" />}
      className="hover:before:opacity-0 bg-blue-500/25 border-blue-500/50 transition-all p-0"
      label={<Typography color="blue-gray" className="font-normal">Free</Typography>}
    />
  </div>
}>
```jsx
