...
<CodePreview id="progress-bar-sizes" link="progress-bar#progress-bar-sizes" component={
  <div className="flex w-full flex-col gap-4">
...
<CodePreview id="progress-bar-sizes-with-label" link="progress-bar#progress-bar-sizes-with-label" component={
  <div className="flex w-full flex-col gap-4">
...
<CodePreview id="progress-bar-with-label-outside" link="progress-bar#progress-bar-with-label-outside" component={
