---
title: Tailwind CSS Crypto Table for React - Material Tailwind
description: Customise your web projects with our easy-to-use crypto table example for Tailwind CSS and React using Material Design guidelines.
navigation:
  [
    "crypto-table",
  ]
github: crypto/crypto-table
---

<DocsTitle href="crypto-table">
# Tailwind CSS Crypto Table - React
</DocsTitle>

Use our Tailwind CSS Crypto Table example to add global search in your web projects.
...
<CodePreview component={<Crypto.CryptoTable />}>
```jsx
