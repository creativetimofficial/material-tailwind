...
<DocsTitle href="custom-tabs-animation">
## Custom Tabs Animation
</DocsTitle>
...
<CodePreview id="vertical-tabs" component={
  <Tabs id="vertical-tabs-component" value="html" orientation="vertical">
...
<CodePreview id="vertical-tabs-with-icon" component={
  <Tabs id="vertical-tabs-wit-icon-component" value="dashboard" orientation="vertical">
    <TabsHeader className="w-40">
      <Tab value="dashboard" className="justify-start">
        <div className="flex items-center gap-2">
          <SolidIcons.Square3Stack3DIcon className="w-5 h-5" />
          Dashboard
        </div>
      </Tab>
      <Tab value="profile" className="justify-start">
        <div className="flex items-center gap-2">
          <SolidIcons.UserCircleIcon className="w-5 h-5" />
          Profile
        </div>
      </Tab>
      <Tab value="settings" className="justify-start">
        <div className="flex items-center gap-2">
          <SolidIcons.Cog6ToothIcon className="w-5 h-5" />
          Settings
        </div>
...
<CodePreview id="underline-tabs" component={
