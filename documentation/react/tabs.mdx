...
navigation: ["tabs", "custom-tabs-animation", "transparent-tabs", "tabs-with-icon", "props", "theme"]
related:
  [
    {
      title: "Props",
...
Use the example below to create <Code>Tabs</Code> component containing icon on it's header.

<CodePreview id="tabs-with-icon" component={<TabsWithIcon />}>
```jsx
import {
  Tabs,
  TabsHeader,
