...
description: Learn how to use Material Tailwind React for building beatiful websites
navigation:
  [
    "quick-start",
    "installation",
...
@material-tailwind/react is free and open-source components library for ReactJS and
