...
Try this notification dialog to highlight important information or required actions. It features a clear title, message area, and action buttons for user response.
