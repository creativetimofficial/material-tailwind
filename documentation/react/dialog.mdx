...
<CodePreview id="long-dialog" link="dialog#long-dialog" className="mt-4" component={<DialogExamples.LongDialog />}>
```jsx
import { Fragment, useState } from "react";
import {
  Button,
...
<CodePreview id="message-dialog" link="dialog#message-dialog" className="mt-4" component={<DialogExamples.MessageDialog />}>
```jsx
import React from "react";
import {
  Button,
...
<CodePreview id="notification-dialog" link="dialog#notification-dialog" className="mt-4" component={<DialogExamples.NotificationDialog />}>
```jsx
import { Fragment, useState } from "react";
import {
  Button,
