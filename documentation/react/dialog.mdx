...
Use this detailed dialog box designed to present extensive text content. It includes a long passage of text and offers options like "Cancel" and "Confirm" for user interaction.
...
Try a compact dialog intended for sending a message. It includes fields for entering a username and a message, along with buttons to "Cancel" or "Send Message."
...
A notification-style dialog that draws attention with a prominent icon and bold text. It provides information and call-to-actions.
...
<DocsTitle href="add-product-dialog">
## Add Product Dialog
</DocsTitle>

A form-based dialog used for adding product details, including fields for name, category, weight, size, and an optional description. It concludes with an "Add Product" button.
...
<DocsTitle href="select-categories-dialog">
## Select Categories Dialog
</DocsTitle>

A simple dialog that allows users to select categories from a list. It includes checkboxes for each option and a button to "Save Categories."
...
<DocsTitle href="delivery-method-dialog">
## Delivery Method Dialog
</DocsTitle>

Use this dialog to select a delivery method from several options. It highlights each option's details and includes a "Confirm Delivery Method" button.
...
<DocsTitle href="order-details-dialog">
## Order Details Dialog
</DocsTitle>

Try this timeline-style dialog that displays the order's progress, showing details like design changes, new orders, and payment completion, with an option to view more details.
...
```
 ...
 <DocsTitle href="upload-progress-dialog">
## Upload Progress Dialog
</DocsTitle>

Use this dialog that tracks the progress of an ongoing upload, including a progress bar, file details, and a call-to-action button.
