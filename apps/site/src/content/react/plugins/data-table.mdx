---
title: Tailwind CSS Data Table - React
description: Customise your web projects with our easy-to-use Data Table example for Tailwind CSS and React using Material Design guidelines and TanStack Table.
...
We're using `@tanstack/react-table` library to provide the data table functionality. Make sure to install it before using the example.
...
<ComponentPreview demo={<DataTable.DataTableDemo />}>
```tsx
"use client";
