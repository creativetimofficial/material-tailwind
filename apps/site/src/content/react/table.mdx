...
description: Customise your web projects with our easy-to-use Table component for Tailwind CSS and React using Material Design guidelines.
github: Table
...
<ComponentPreview demo={<Table.TableDemo />}>
```tsx
...
<ComponentPreview demo={<Table.TableWithStripedRow />}>
```tsx
import { Card, Typography } from "@material-tailwind/react";
...
<ComponentPreview demo={<Table.TableWithStripedColumn />}>
```tsx
import { Card, Typography } from "@material-tailwind/react";
...
<ComponentPreview demo={<Table.TransactionsTable />}>
```tsx
...
<ComponentPreview demo={<Table.MembersTable />}>
```tsx
...
<ComponentPreview demo={<Table.SortableTable />}>
```tsx
import {
  EditPencil,
  UserPlus,
