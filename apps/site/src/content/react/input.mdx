  ...
  return (
    <Input className="w-72">
      <Input.Field
        ...
        className="rounded-none border-0 border-b border-gray-400 pe-0.5 ring-0 hover:border-gray-900 focus:border-gray-900 data-[icon-placement=start]:ps-[26px] dark:border-gray-600 dark:hover:border-gray-50 dark:focus:border-gray-50"
      />
