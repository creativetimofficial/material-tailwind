...
The `Textarea` component comes with 3 different sizes that you can change it using the `size` prop.
...
The `Textarea` component comes with 6 different colors that you can change it using the `color` prop.
...
You can combine the `Textarea` component with the `Typography` component to create a validation message.
...
You can combine the `Textarea` component with the `Typography` component to add a label for the `Textarea` component.
...
You can combine the `Textarea` component with the `Typography` component to add some description under the `Textarea` component.
...
Use the example below for creating X chatbox using `Textarea`.
