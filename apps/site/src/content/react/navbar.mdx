  ...
  return (
    <Menu>
      <Menu.Trigger
        ...
        alt="profile-picture"
        size="sm"
        className="border-primary border p-0.5 lg:ml-auto"
      />
      <Menu.Content>
        <Menu.Item>
          <UserCircle className="mr-2 h-[18px] w-[18px]" /> My Profile
        ...
        <div className="hidden lg:block">
          <List className="mt-4 flex flex-col gap-1 lg:mt-0 lg:flex-row lg:items-center">
            <Tooltip placement="bottom" interactive>
              ...
              <Tooltip.Content className="shadow-primary/[0.025] z-[100000] grid max-w-screen-xl rounded-lg border border-secondary-dark bg-secondary p-2 shadow-xl">
