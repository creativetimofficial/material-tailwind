...
import { Input, Popover } from "@material-tailwind/react/dist";
      ...
      <Popover.Content>
        ...
        <DayPicker
          ...
          classNames={{
            ...
            head_row: "flex font-medium text-primary",
            day_disabled: "text-foreground opacity-50",
            head_cell: "m-0.5 w-9 font-normal text-sm",
            day_today: "rounded-md bg-surface text-primary",
            ...
            day_outside:
              "day-outside text-foreground opacity-50 aria-selected:bg-primary-light aria-selected:text-primary aria-selected:bg-opacity-10",
