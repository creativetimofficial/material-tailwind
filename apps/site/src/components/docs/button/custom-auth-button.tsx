...
export function CustomAuthButton() {
  return (
    <div className="flex flex-wrap justify-center gap-4">
      ...
      <Button className="border-blue-50 bg-white text-gray-950 hover:border-blue-100 hover:bg-white hover:text-blue-500 focus:border-blue-100 focus:bg-white focus:text-blue-500">
