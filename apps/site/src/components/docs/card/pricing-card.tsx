...
export function PricingCard() {
  return (
    <Card color="primary" className="max-w-xs">
      ...
      <hr className="mx-3 border-primary-light dark:border-primary-dm-dark" />
      <Card.Body as="ul" className="space-y-3 px-8 pb-6 pt-8">
        <li className="flex items-center gap-4 text-secondary-main dark:text-secondary-dm-main">
