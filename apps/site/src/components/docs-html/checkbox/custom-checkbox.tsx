...
export default function CustomCheckbox() {
  return (
    ...
    <label class="flex items-center cursor-pointer relative" for="checkbox-custom">
      <input type="checkbox" class="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded-full shadow-sm  border border-slate-200 checked:bg-slate-800 checked:border-slate-800" id="checkbox-custom" />
