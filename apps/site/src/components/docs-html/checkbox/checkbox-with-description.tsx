...
export default function CheckboxWithDescription() {
  ...
  <label class="flex items-start cursor-pointer relative" for="checkbox-description">
    <input type="checkbox" class="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow-sm  border border-slate-200 checked:bg-slate-800 checked:border-slate-800" id="checkbox-description" />
