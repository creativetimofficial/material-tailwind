...
export default function CheckboxWithLabel() {
  ...
  <label class="flex items-center cursor-pointer relative" for="checkbox-with-label">
    <input type="checkbox" class="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow-sm hover:shadow-md border border-slate-200 checked:bg-slate-800 checked:border-slate-800" id="checkbox-with-label" />
