...
export default function BadgeOverlap() {
  ...
  <div class="relative inline-flex">
    <div class=""><button class="relative inline-grid min-h-[36px] min-w-[36px] select-none place-items-center overflow-hidden rounded-md border border-slate-200 bg-slate-200 text-center align-middle font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:bg-slate-100 hover:bg-slate-100"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4 stroke-2">
