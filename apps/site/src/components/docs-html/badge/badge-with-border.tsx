...
export default function BadgeWithBorder() {
  return (
    ...
    <span class="absolute right-[6%] top-[6%] grid min-h-[10px] min-w-[10px] -translate-y-1/2 translate-x-1/2 place-items-center rounded-full border border-white bg-slate-800 px-1 py-0.5 text-xs leading-none text-slate-50">5</span>
</div>
