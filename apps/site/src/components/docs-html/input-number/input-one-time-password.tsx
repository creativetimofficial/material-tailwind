...
export default function InputOneTimePassword() {
  ...
  <div class="flex items-center space-x-2">
    <input type="text" maxlength="1" class="w-10 h-10 bg-transparent text-center placeholder:text-slate-400 text-slate-700 text-lg border border-slate-200 rounded-md transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" oninput="handleChange(this, 0)" onkeydown="handleBackspace(event, 0)" />
