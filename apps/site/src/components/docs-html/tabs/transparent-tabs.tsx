...
<div class="relative tab-group">
  <div class="flex p-0.5 relative rounded-lg" role="tablist">
    ...
    <a href="#" class="tab-link text-sm active inline-block py-2 px-4 text-stone-800 transition-all duration-300 relative z-1 mr-1" data-dui-tab-target="tab1-group3">
      HTML
    </a>
  ...
  <div class="mt-4 tab-content-container">
    <div id="tab1-group3" class="tab-content text-stone-500 text-sm block">
