...
export default function VerticalTabsWithIcon() {
  return (
    <div
      dangerouslySetInnerHTML={{
        __html: `<div class="tab-group flex mt-10 w-6/12" data-orientation="vertical">
  <div role="tablist" class="relative bg-slate-100 rounded-lg flex flex-col p-1 w-10/12">
    ...
    <a href="#" class="tab-link flex items-center text-sm active px-4 py-2 text-gray-700 relative" data-tab-target="tab-vertical-dashboard">
    ...
    <a href="#" class="tab-link flex items-center text-sm px-4 py-2 text-gray-700 relative" data-tab-target="tab-vertical-profile">
      <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="mr-2 h-4 w-4">
    ...
    <a href="#" class="tab-link flex items-center text-sm px-4 py-2 text-gray-700 relative" data-tab-target="tab-vertical-settings">
      <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="mr-2 h-4 w-4">
  ...
  <div id="tab-vertical-dashboard" class="tab-content w-full text-slate-800 block p-4">
  ...
  <div id="tab-vertical-profile" class="tab-content w-full text-slate-800 hidden p-4">
  ...
  <div id="tab-vertical-settings" class="tab-content w-full text-slate-800 hidden p-4">
