    ...
    <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <h6 className="mb-4 font-sans text-base font-bold text-inherit antialiased md:text-lg lg:text-xl">
            Material Tailwind
          </h6>
          <div className="grid grid-cols-3 justify-between gap-x-6 gap-y-4">
            <ul>
              <p className="mb-2 font-sans text-base font-semibold text-inherit antialiased opacity-50">
                Product
              </p>
              <li>
                <a
                  href="#"
                  className="py-1 font-sans text-base text-inherit antialiased hover:text-primary"
                >
                  Overview
                </a>
              </li>
        ...
        <div className="mt-10 flex w-full flex-col items-center justify-center gap-4 border-t border-surface py-4 md:flex-row md:justify-between">
          <small className="text-center font-sans text-sm text-inherit antialiased">
            © 2024{" "}
