  ...
  return (
    <div className="flex flex-wrap justify-center gap-4">
      <button
        ...
        className="inline-flex select-none items-center justify-center rounded-md border border-[#F7931A] bg-[#F7931A] px-3.5 py-2.5 text-center align-middle font-sans text-sm font-medium leading-none text-white transition-all duration-300 ease-in hover:border-[#F7931A] hover:bg-[#F7931A] hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
      >
        <svg
          width="1.5em"
          height="1.5em"
      ...
      <button
        data-ripple-light="true"
        className="inline-flex select-none items-center justify-center rounded-md border border-white bg-white px-3.5 py-2.5 text-center align-middle font-sans text-sm font-medium leading-none text-black shadow-md shadow-black/10 transition-all duration-300 ease-in hover:border-white hover:bg-white hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
      >
        <svg
          width="1.5em"
          height="1.5em"
