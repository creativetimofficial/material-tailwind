...
export default function StepperCustomStyles() {
  ...
  <div class="flex w-full items-center bg-slate-800 p-6 rounded-full">
    <div aria-disabled="false" data-step class="group w-full flex items-center">
      <div class="relative">
        <span class="relative grid h-4 w-4 place-items-center rounded-full bg-slate-600 group-data-[active=true]:bg-slate-50 group-data-[active=true]:text-slate-800 group-data-[completed=true]:bg-slate-50 group-data-[completed=true]:text-slate-800"></span></div>
      <div class="flex-1 h-0.5 bg-slate-600 group-data-[completed=true]:bg-slate-50"></div>
    </div>
    <div aria-disabled="true" data-step class="group w-full flex items-center">
      <div class="relative">
        <span class="relative grid h-4 w-4 place-items-center rounded-full bg-slate-600 group-data-[active=true]:bg-slate-50 group-data-[active=true]:text-slate-800 group-data-[completed=true]:bg-slate-50 group-data-[completed=true]:text-slate-800"></span>
      </div>
      <div class="flex-1 h-0.5 bg-slate-600 group-data-[completed=true]:bg-slate-50"></div>
    </div>
