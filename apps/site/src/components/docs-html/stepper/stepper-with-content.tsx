  ...
  <div class="flex w-full items-center justify-between">
    <div aria-disabled="false" data-step class="group w-full flex items-center">
      <div class="relative">
        ...
        <span class="absolute -bottom-6 start-0 whitespace-nowrap text-slate-800 font-bold md:text-lg lg:text-xl top-12">Step 1</span>
      </div>
    ...
    <div aria-disabled="true" data-step class="group w-full flex items-center">
      <div class="relative">
        ...
        <span class="absolute -bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap text-slate-800 font-bold md:text-lg lg:text-xl top-12">Step 2</span>
      </div>
      <div class="flex-1 h-1 bg-slate-200 group-data-[completed=true]:bg-slate-800"></div>
    </div>
    <div aria-disabled="true" data-step class="group flex items-center">
      <div class="relative">
        ...
        <span class="absolute -bottom-6 end-0 whitespace-nowrap text-slate-800 font-bold md:text-lg lg:text-xl top-12">Step 3</span>
      </div>
    </div>
  </div>
