...
export default function StepperWithDots() {
  ...
  <div class="flex w-full items-center">
    <div aria-disabled="false" data-step class="group w-full flex items-center">
      <div class="relative">
        <span class="relative grid h-4 w-4 place-items-center rounded-full bg-slate-200  group-data-[active=true]:bg-slate-800 group-data-[active=true]:text-white group-data-[completed=true]:bg-slate-800 group-data-[completed=true]:text-white"></span>
      </div>
      <div class="flex-1 h-0.5 bg-slate-200 group-data-[completed=true]:bg-slate-800"></div>
    </div>
