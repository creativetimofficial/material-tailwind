  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      import("apexcharts").then((ApexCharts) => {
        ...
        const chart = new ApexCharts.default(document.querySelector("#line-chart"), options);
        chart.render();
...
<div class="w-full rounded-lg border shadow-sm overflow-hidden bg-background border-surface shadow-black/5">
  <div class="relative mx-4 mt-4 flex flex-col gap-4 overflow-hidden rounded-none bg-transparent bg-clip-border text-slate-500shadow-none md:flex-row md:items-center">
    ...
    <div>
      ...
      <p class="block max-w-sm font-sans text-sm font-normal leading-normal text-slate-500antialiased">
