...
<div class="relative">
  ...
  >
    <div class="w-full rounded-lg border shadow-sm overflow-hidden bg-white border-slate-200 shadow-slate-950/5 max-w-[280px] h-screen">
        ...
        <ul class="flex flex-col gap-0.5 min-w-60 mt-3">
          ...
          <li>
            <div data-toggle="collapse" 
                data-target="#sidebarWithBurgerMenuCollapseList1" 
                aria-expanded="false" 
                aria-controls="sidebarWithBurgerMenuCollapseList1" 
            ...
            <div class="overflow-hidden transition-[max-height] duration-300 ease-in-out max-h-0" id="sidebarWithBurgerMenuCollapseList1">
