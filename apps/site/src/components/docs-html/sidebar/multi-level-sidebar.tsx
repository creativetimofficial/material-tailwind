            ...
            return (
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: 
`
<div class="w-full rounded-lg border shadow-sm bg-white border-slate-200 shadow-slate-950/5 max-w-[280px]">
    ...
    <ul class="flex flex-col gap-0.5 min-w-60">
      ...
      <li>
        <div data-toggle="collapse" 
            data-target="#multiLevelSidebarCollapseList" 
            aria-expanded="false" 
            aria-controls="multiLevelSidebarCollapseList" 
        ...
        <div class="overflow-hidden transition-[max-height] duration-300 ease-in-out max-h-0" id="multiLevelSidebarCollapseList">
          <ul class="flex flex-col gap-0.5 min-w-60">
