...
<div class="w-full rounded-lg border shadow-sm overflow-hidden bg-white border-slate-200 shadow-slate-950/5 max-w-[280px]">
  <div class="w-[calc(100%-16px)] rounded m-2 mx-4 mb-0 mt-3 h-max">
    ...
    <ul class="flex flex-col gap-0.5 min-w-60">
      ...
      <li>
        <div data-toggle="collapse" 
            data-target="#sidebarWithCtaCollapseList" 
            aria-expanded="false" 
            aria-controls="sidebarWithCtaCollapseList" 
        ...
        <div class="overflow-hidden transition-[max-height] duration-300 ease-in-out max-h-0" id="sidebarWithCtaCollapseList">
          <ul class="flex flex-col gap-0.5 min-w-60">
