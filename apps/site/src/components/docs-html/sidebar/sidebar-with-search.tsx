            ...
            return (
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: 
`
<div class="w-full rounded-lg border shadow-sm overflow-hidden bg-white border-slate-200 shadow-slate-950/5 max-w-[280px]">
  <div class="rounded m-2 mx-3 mb-0 mt-3 flex h-max items-center gap-2">
    ...
    <ul class="flex flex-col gap-0.5 min-w-60 mt-3">
      <li href="#" class="flex items-center py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in aria-disabled:opacity-50 aria-disabled:pointer-events-none bg-transparent text-slate-600 hover:text-slate-800 dark:hover:text-white hover:bg-slate-200 focus:bg-slate-200 focus:text-slate-800 dark:focus:text-white dark:data-[selected=true]:text-white dark:bg-opacity-70">
        ...
        <span class="grid place-items-center shrink-0 ps-2.5 ms-auto">
          <div class="relative inline-flex w-max items-center border font-sans font-medium rounded-md text-xs p-0.5 bg-slate-800/10 border-transparent text-slate-800 shadow-none">
      ...
      <li>
        <div data-toggle="collapse" 
            data-target="#sidebarWithSearchCollapseList" 
            aria-expanded="false" 
            aria-controls="sidebarWithSearchCollapseList" 
          ...
          <span data-icon class="grid place-items-center shrink-0 transition-transform duration-300 ease-in-out">
            <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4 stroke-[1.5] dark:stroke-slate-300">
              <path d="M6 9L12 15L18 9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
          </span>    
        </div>
        <div class="overflow-hidden transition-[max-height] duration-300 ease-in-out max-h-0" id="sidebarWithSearchCollapseList">
  ...
  <div class="w-full px-3.5 pt-2 pb-3.5 rounded mt-8">
    <div class="w-full rounded-lg border overflow-hidden bg-slate-800 border-slate-950 shadow-slate-950/25 shadow-none">
      ...
      <div class="w-full px-3.5 pt-2 pb-3.5 rounded">
        <a href="#" class="inline-flex items-center justify-center border align-middle font-medium text-center transition-all duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed focus:shadow-none text-sm rounded-md py-1.5 px-3 shadow-sm hover:shadow border-white bg-white text-slate-950 hover:border-white hover:bg-white hover:text-slate-950">Upgrade Now</a>
      </div>
    </div>
  </div>
</div>
