    ...
    <ul class="flex flex-col gap-0.5 min-w-60 mt-3">
      ...
      <li>
        <div data-toggle="collapse" 
            data-target="#sidebarWithSearchCollapse" 
            aria-expanded="false" 
            aria-controls="sidebarWithSearchCollapse" 
        ...
        <div class="overflow-hidden transition-[max-height] duration-300 ease-in-out max-h-0" id="sidebarWithSearchCollapse">
