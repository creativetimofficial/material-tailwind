...
<div class="min-h-72">
  ...
  <div data-dui-popover-content class="hidden">
    <div class="mb-2 flex items-center justify-between gap-4">
      ...
      <button class="inline-flex items-center justify-center border align-middle select-none font-sans font-medium text-center duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed focus:shadow-none text-sm py-2 px-4 shadow-sm hover:shadow-md bg-stone-800 hover:bg-stone-700 relative bg-gradient-to-b from-stone-700 to-stone-800 border-stone-900 text-stone-50 rounded-lg after:absolute after:inset-0 after:rounded-[inherit] after:box-shadow after:shadow-[inset_0_1px_0px_rgba(255,255,255,0.25),inset_0_-2px_0px_rgba(0,0,0,0.35)] after:pointer-events-none transition antialiased">Follow</button>
    </div>
    <p class="font-sans antialiased text-base text-stone-800 dark:text-white mb-1 flex items-center gap-2 font-bold">
      <span>Alex Andrew</span> • <a href="#profile-info-popover" class="font-sans antialiased text-base text-inherit" data-tabindex="" tabindex="-1">@alex</a>
    </p>
    <small class="font-sans antialiased text-sm text-stone-500">Frontend Developer • Major interest in Web Development: motivated to achieve measurable results, to deepen my knowledge and improve my skills.</small>
    <hr class="-mx-2.5 my-2.5 border-stone-200">
    <div class="flex items-center gap-8">
      <small class="font-sans antialiased text-sm text-stone-800 dark:text-white flex items-center gap-1.5">
