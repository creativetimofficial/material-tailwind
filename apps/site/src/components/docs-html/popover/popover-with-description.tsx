...
<div class="min-h-48">
  ...
  <div data-dui-popover-content class="hidden">
    ...
    <small class="font-sans antialiased text-sm text-stone-500">@material-tailwind is an easy-to-use components library for Tailwind CSS and Material Design.</small>
    <div class="mt-4 flex items-center gap-4">
      <div class="flex items-center gap-1.5">
        <span class="h-2.5 w-2.5 rounded-full bg-blue-500"></span>
        <small class="font-sans antialiased text-sm text-stone-800 dark:text-white">TypeScript</small>
      </div>
      <div class="flex items-center gap-1.5">
        <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4 text-warning">
        ...
        <small class="font-sans antialiased text-sm text-stone-800 dark:text-white">1,480</small>
      </div>
      <div class="flex items-center gap-1.5">
        <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4 text-success">
        ...
        <small class="font-sans antialiased text-sm text-stone-800 dark:text-white">Veritied</small>
      </div>
    </div>
  </div>
</div>
