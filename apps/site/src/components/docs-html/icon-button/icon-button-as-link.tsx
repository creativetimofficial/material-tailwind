export function IconButtonAsLink() {
  return (
    <div className="flex gap-4">
      ...
      <a
        href="#"
        className="inline-grid min-h-[36px] min-w-[36px] select-none place-items-center rounded-md border border-primary bg-primary text-center align-middle font-sans text-sm font-medium leading-none text-primary-foreground transition-all duration-300 ease-in hover:border-primary-light hover:bg-primary-light disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
      >
        <svg
          width="1.5em"
          height="1.5em"
      ...
      <a
        href="#"
        className="inline-grid min-h-[36px] min-w-[36px] select-none place-items-center rounded-md border border-primary bg-gradient-to-tr from-primary-dark to-primary-light text-center align-middle font-sans text-sm font-medium leading-none text-primary-foreground transition-all duration-300 ease-in hover:brightness-105 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
      >
        <svg
          width="1.5em"
          height="1.5em"
