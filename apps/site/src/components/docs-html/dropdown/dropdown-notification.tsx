...
<div class="dropdown" data-dui-placement="bottom">
  <button data-dui-toggle="dropdown" aria-expanded="false" class="inline-grid place-items-center border align-middle select-none font-sans font-medium text-center transition-all duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-sm min-w-[38px] min-h-[38px] rounded-md bg-transparent border-transparent text-stone-800 hover:bg-stone-800/5 hover:border-stone-800/5 shadow-none hover:shadow-none">
  ...
  <div data-dui-role="menu" class="hidden min-w-40 grid max-w-lg grid-cols-1 gap-3 mt-2 bg-white border border-stone-200 rounded-lg shadow-sm p-1 z-10">
    ...
    <div class="w-full text-start flex items-center p-1.5 rounded gap-3 hover:bg-stone-100 cursor-pointer">
      <img src="https://dub.sh/6i238JA" alt="profile-picture" class="object-cover w-11 h-11 rounded-md">
      <div>
        <small class="text-sm font-semibold text-stone-800">Natali replied to your email</small>
        <small class="flex items-center gap-1 text-xs text-stone-500">
          <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3">
            <path d="M12 6L12 12L18 12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <div class="w-full text-start flex items-center p-1.5 px-2.5 rounded gap-3 hover:bg-stone-100 cursor-pointer">
      <img src="https://dub.sh/iuFsnmW" alt="profile-picture" class="object-cover w-11 h-11 rounded-md">
      <div>
        <small class="text-sm font-semibold text-stone-800">You've received a payment</small>
        <small class="flex items-center gap-1 text-xs text-stone-500">
          <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3">
            <path d="M12 6L12 12L18 12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
