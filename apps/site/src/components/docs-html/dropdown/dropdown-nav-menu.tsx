...
<div class="dropdown" data-dui-placement="bottom">
  <button data-dui-toggle="dropdown" aria-expanded="false" class="inline-flex items-center justify-center border align-middle select-none font-sans font-medium text-center transition-all duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed focus:shadow-none text-sm rounded-md py-2 px-4 bg-transparent border-transparent text-stone-800 hover:bg-stone-800/5 hover:border-stone-800/5 shadow-none hover:shadow-none">
    Versions 
  ...
  <div data-dui-role="menu" class="hidden min-w-40 grid max-w-lg grid-cols-5 gap-1 mt-2 bg-white border border-stone-200 rounded-lg shadow-sm p-1 z-10">
    <div class="w-full bg-stone-800 col-span-2 grid place-items-center rounded-md px-8 py-4">
      <div class="text-center flex flex-col items-center justify-center">
        ...
        <h6 class="font-bold text-white mt-5 text-center">David UI</h6>
      </div>
    </div>
    <ul class="col-span-3 m-0">
      <a href="#" onclick="event.preventDefault();" class="w-full text-start flex flex-col py-1.5 px-2.5 rounded bg-transparent hover:bg-stone-100 cursor-pointer">
        <p class="font-semibold text-stone-800">Material Tailwind HTML</p>
        <small class="text-stone-500">Learn how to use @material-tailwind/html, packed with rich components and widgets.</small>
      </a>
      <a href="#" onclick="event.preventDefault();" class="w-full text-start flex flex-col py-1.5 px-2.5 rounded bg-transparent hover:bg-stone-100 cursor-pointer">
        <p class="font-semibold text-stone-800">Material Tailwind React</p>
        <small class="text-stone-500">Learn how to use @material-tailwind/react, packed with rich components for React.</small>
      </a>
      <a href="#" onclick="event.preventDefault();" class="w-full text-start flex flex-col py-1.5 px-2.5 rounded bg-transparent hover:bg-stone-100 cursor-pointer">
      <p class="font-semibold text-stone-800">David UI</p>
      <small class="text-stone-500">A complete set of UI Elements for building faster websites in less time.</small>
      </a>
    </ul>
  </div>
</div>
