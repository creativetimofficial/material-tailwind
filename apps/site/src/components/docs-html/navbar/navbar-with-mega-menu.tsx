      ...
      <div className="flex items-center">
        ...
        <div className="hidden lg:block">
          <ul className="mt-4 flex min-w-[240px] flex-col gap-1 lg:mt-0 lg:flex-row lg:items-center">
              ...
              <li className="flex select-none items-center rounded-md bg-transparent px-2.5 py-1.5 align-middle font-sans text-foreground transition-all duration-300 ease-in hover:bg-surface hover:text-black focus:bg-surface focus:text-black aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:bg-opacity-70 dark:hover:text-white dark:focus:text-white">
                ...
                <span className="ms-auto grid shrink-0 place-items-center ps-2.5">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    color="currentColor"
                    className="h-3.5 w-3.5 group-data-[open=true]:rotate-180"
                  >
                    <path
                      d="M6 9L12 15L18 9"
                      stroke="currentColor"
            ...
            <a
              href="#"
              className="flex select-none items-center rounded-md bg-transparent px-2.5 py-1.5 align-middle font-sans text-foreground transition-all duration-300 ease-in hover:bg-surface hover:text-black focus:bg-surface focus:text-black aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:bg-opacity-70 dark:hover:text-white dark:focus:text-white"
            >
              <span className="me-2.5 mr-1.5 grid shrink-0 place-items-center">
                <svg
                  width="1.5em"
                  height="1.5em"
                  stroke-width="1.5"
