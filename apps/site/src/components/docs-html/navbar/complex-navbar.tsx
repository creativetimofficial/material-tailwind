    ...
    <div class="hidden lg:block">
      <div class="min-w-60 mt-4 flex flex-col gap-1 lg:mt-0 lg:flex-row lg:items-center">
        <div class="dropdown" data-placement="bottom-start">
          ...
          <div data-role="menu" class="hidden mt-2 bg-white border border-slate-200 rounded-lg shadow-sm p-1 z-10">
            <a href="#" class="block px-4 py-2 text-sm text-slate-800 hover:bg-slate-200 rounded-md">Landing Page</a>
            <a href="#" class="block px-4 py-2 text-sm text-slate-800 hover:bg-slate-200 rounded-md">About Us</a>
            <a href="#" class="block px-4 py-2 text-sm text-slate-800 hover:bg-slate-200 rounded-md">Contact</a>
            <a href="#" class="block px-4 py-2 text-sm text-slate-800 hover:bg-slate-200 rounded-md">Author</a>
            <a href="#" class="block px-4 py-2 text-sm text-slate-800 hover:bg-slate-200 rounded-md">Sign In</a>
          </div>
        </div>
  ...
  <div class="overflow-scroll transition-[max-height] duration-300 ease-in-out max-h-0 lg:hidden" id="navbar-collapse">
    <div class="min-w-60 mt-4 flex flex-col gap-1"> 
      <div data-toggle="collapse" 
          data-target="#navbar-collapse-list" 
          aria-expanded="false" 
