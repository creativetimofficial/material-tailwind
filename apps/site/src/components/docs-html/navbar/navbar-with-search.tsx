  ...
  return (
    <nav className="mx-auto w-full max-w-(--breakpoint-xl) overflow-hidden rounded-lg border border-surface bg-background p-2 shadow-lg shadow-black/5">
      <div className="flex items-center">
        ...
        <div className="relative ml-auto w-40 rounded-md text-sm leading-none">
          <span className="pointer-events-none absolute left-[5px] top-1/2 h-4 w-4 -translate-y-1/2 overflow-hidden text-foreground/70 transition-all duration-300 ease-in peer-hover:text-black peer-focus:text-black dark:peer-hover:text-white dark:peer-focus:text-white">
            <svg
              width="1.5em"
              height="1.5em"
              viewBox="0 0 24 24"
