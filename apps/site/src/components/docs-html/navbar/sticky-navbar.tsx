    ...
    <div className="h-96 w-full overflow-scroll">
      <nav className="sticky top-0 mx-auto w-full max-w-(--breakpoint-xl) overflow-hidden rounded-lg border border-surface bg-background p-2 shadow-lg shadow-black/5">
        <div className="flex items-center">
          ...
          <button className="hidden select-none items-center justify-center rounded-md border border-primary bg-primary px-2.5 py-1.5 text-center align-middle font-sans text-sm font-medium leading-none text-primary-foreground transition-all duration-300 ease-in hover:border-primary-light hover:bg-primary-light lg:ml-auto lg:inline-block">
            Sign In
          </button>
          <button className="ml-auto grid min-h-[28px] min-w-[28px] select-none place-items-center rounded-md border border-transparent bg-transparent text-center align-middle font-sans text-sm font-medium leading-none text-secondary-foreground transition-all duration-300 ease-in hover:border-secondary/10 hover:bg-secondary/10 lg:hidden">
            <svg
              width="1.5em"
              height="1.5em"
              stroke-width="1.5"
          ...
          <div className="mb-6 max-w-xl">
            <div className="flex h-56 w-full items-center justify-center rounded bg-surface">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                color="currentColor"
                className="h-16 w-16 text-surface-dark"
              >
                <path
