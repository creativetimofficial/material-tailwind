...
export default function StickyNavbar() {
  return (
    <div
      dangerouslySetInnerHTML={{
        __html: `<div class="h-96 w-full overflow-scroll">
  <nav class="sticky top-0 mx-auto w-full max-w-screen-xl overflow-hidden rounded-lg border border-slate-200 bg-white p-2 shadow-lg shadow-slate-950/5">
    <div class="flex items-center"><a href="#" class="ml-2 mr-2 block py-1 font-sans text-sm font-semibold text-current antialiased">Material Tailwind</a>
      ...
      <div class="hidden lg:block">
        <ul class="mt-4 flex flex-col gap-x-3 gap-y-1.5 lg:mt-0 lg:flex-row lg:items-center">
          <li><a href="#" class="flex items-center gap-x-2 p-1 font-sans text-sm text-current antialiased hover:text-primary"><svg width="1.5em" height="1.5em" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
          ...
          <li><a href="#" class="flex items-center gap-x-2 p-1 font-sans text-sm text-current antialiased hover:text-primary"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
      ...
      </div><button class="hidden select-none items-center justify-center rounded-md border border-slate-800 bg-slate-800 px-2.5 py-1.5 text-center align-middle font-sans text-sm font-medium leading-none text-slate-50 transition-all duration-300 ease-in hover:border-slate-700 hover:bg-slate-700 lg:ml-auto lg:inline-block">Sign In</button><button class="ml-auto grid min-h-[28px] min-w-[28px] select-none place-items-center rounded-md border border-transparent bg-transparent text-center align-middle font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:border-slate-600/10 hover:bg-slate-200/10 lg:hidden"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
  ...
  <main class="w-full">
    <div class="mx-auto max-w-xl">
      <div class="my-8">
        <div class="mb-2 h-2 w-full rounded-full bg-slate-200"></div>
        <div class="mb-2 h-2 w-full rounded-full bg-slate-200"></div>
        <div class="mb-2 h-2 w-full rounded-full bg-slate-200"></div>
        <div class="mb-2 h-2 w-full rounded-full bg-slate-200"></div>
        <div class="mb-2 h-2 w-full rounded-full bg-slate-200"></div>
      ...
      <div class="mb-6 max-w-xl">
        <div class="flex h-56 w-full items-center justify-center rounded bg-slate-200"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-16 w-16 text-surface-dark">
