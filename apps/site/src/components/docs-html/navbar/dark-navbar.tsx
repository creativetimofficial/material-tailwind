  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: `<nav class="rounded-lg border shadow-lg overflow-hidden p-2 border-slate-200 shadow-slate-950/5 mx-auto w-full max-w-screen-xl bg-slate-950 dark:bg-surface-dark">
  <div class="flex items-center text-white"><a href="#" class="font-sans antialiased text-sm text-current ml-2 mr-2 block py-1 font-semibold">Material Tailwind</a>
    ...
    <div class="hidden lg:block">
      <ul class="mt-4 flex flex-col gap-x-3 gap-y-1.5 lg:mt-0 lg:flex-row lg:items-center">
        <li><a href="#" class="font-sans antialiased text-sm flex items-center gap-x-2 p-1 text-white hover:text-white"><svg width="1.5em" height="1.5em" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
        ...
        <li><a href="#" class="font-sans antialiased text-sm flex items-center gap-x-2 p-1 text-white hover:text-white"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
    ...
    </div><button class="items-center justify-center border align-middle select-none font-sans font-medium text-center transition-all duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed data-[shape=pill]:rounded-full data-[width=full]:w-full focus:shadow-none text-sm rounded-md py-1.5 px-3 shadow-sm hover:shadow hidden border-white bg-white text-slate-800 hover:border-white hover:bg-white hover:text-slate-800 lg:ml-auto lg:inline-block" data-shape="default" data-width="default">Sign In</button><button class="place-items-center border align-middle select-none font-sans font-medium text-center transition-all duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none data-[shape=circular]:rounded-full text-sm min-w-[34px] min-h-[34px] rounded-md shadow-sm hover:shadow bg-slate-200 border-slate-200 text-slate-800 hover:bg-slate-100 hover:bg-slate-100 ml-auto grid lg:hidden" data-shape="default"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
