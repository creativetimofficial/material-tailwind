  ...
  return (
    <nav className="mx-auto w-full max-w-(--breakpoint-xl) overflow-hidden rounded-lg border border-surface bg-black p-2 shadow-lg shadow-black/5 dark:bg-surface-dark">
      <div className="flex items-center text-white">
        ...
        <div className="hidden lg:block">
          <ul className="mt-4 flex flex-col gap-x-3 gap-y-1.5 lg:mt-0 lg:flex-row lg:items-center">
            <li>
              <a
                href="#"
                className="flex items-center gap-x-2 p-1 font-sans text-sm text-white antialiased hover:text-white"
              >
                <svg
                  width="1.5em"
                  height="1.5em"
        ...
        <button className="hidden select-none items-center justify-center rounded-md border border-white bg-white px-2.5 py-1.5 text-center align-middle font-sans text-sm font-medium leading-none text-black transition-all duration-300 ease-in hover:border-white hover:bg-white hover:text-black disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none lg:ml-auto lg:inline-block">
          Sign In
        </button>
        <button className="ml-auto grid min-h-[28px] min-w-[28px] select-none place-items-center rounded-md border border-secondary bg-secondary text-center align-middle font-sans text-sm font-medium leading-none text-secondary-foreground transition-all duration-300 ease-in hover:border-secondary-light hover:bg-secondary-light disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:hidden">
          <svg
            width="1.5em"
            height="1.5em"
            stroke-width="1.5"
