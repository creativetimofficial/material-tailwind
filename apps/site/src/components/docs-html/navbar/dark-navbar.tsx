  ...
  return (
    <div
      dangerouslySetInnerHTML={{
        __html: `<nav class="mx-auto w-full max-w-screen-xl overflow-hidden rounded-lg border border-slate-200 bg-slate-950 p-2 shadow-lg shadow-slate-950/5 dark:bg-surface-dark">
  <div class="flex items-center text-white"><a href="#" class="ml-2 mr-2 block py-1 font-sans text-sm font-semibold text-current antialiased">Material Tailwind</a>
    ...
    <div class="hidden lg:block">
      <ul class="mt-4 flex flex-col gap-x-3 gap-y-1.5 lg:mt-0 lg:flex-row lg:items-center">
        <li><a href="#" class="flex items-center gap-x-2 p-1 font-sans text-sm text-white antialiased hover:text-white"><svg width="1.5em" height="1.5em" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
        ...
        <li><a href="#" class="flex items-center gap-x-2 p-1 font-sans text-sm text-white antialiased hover:text-white"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
    ...
    </div><button class="hidden select-none items-center justify-center rounded-md border border-white bg-white px-2.5 py-1.5 text-center align-middle font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:border-white hover:bg-white hover:text-black disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none lg:ml-auto lg:inline-block">Sign In</button><button class="ml-auto grid min-h-[28px] min-w-[28px] select-none place-items-center rounded-md border border-slate-200 bg-slate-200 text-center align-middle font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:bg-slate-100 hover:bg-slate-100 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:hidden"><svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="h-4 w-4">
