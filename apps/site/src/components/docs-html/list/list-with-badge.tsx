    ...
    <ul className="flex min-w-[240px] flex-col gap-0.5">
      <li className="flex select-none items-center rounded-md bg-transparent px-2.5 py-1.5 align-middle font-sans text-foreground transition-all duration-300 ease-in hover:bg-surface hover:text-black focus:bg-surface focus:text-black dark:bg-opacity-70 dark:hover:text-white dark:focus:text-white">
        ...
        <span className="ms-auto grid shrink-0 place-items-center ps-2.5">
          <div className="relative inline-flex select-none items-center rounded-full border border-transparent bg-primary/10 p-0.5 font-sans text-xs font-medium leading-none text-primary">
      ...
      <li className="flex select-none items-center rounded-md bg-transparent px-2.5 py-1.5 align-middle font-sans text-foreground transition-all duration-300 ease-in hover:bg-surface hover:text-black focus:bg-surface focus:text-black dark:bg-opacity-70 dark:hover:text-white dark:focus:text-white">
        ...
        <span className="ms-auto grid shrink-0 place-items-center ps-2.5">
          <div
            data-open="true"
            className="relative inline-flex select-none items-center rounded-full border border-transparent bg-primary/10 p-0.5 font-sans text-xs font-medium leading-none text-primary"
          >
            <span className="font-inherit mx-1.5 my-0.5 leading-none text-inherit">
              40
            </span>
