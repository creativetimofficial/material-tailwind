...
export default function ProgressLabelOutside() {
  ...
  <p class="flex items-center justify-between font-sans text-base font-semibold text-slate-800 antialiased dark:text-white"><span>Completed</span><span>50%</span></p>
