...
export default function DialogWithImage() {
  return (
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: `<div class="flex items-center">
  <button data-toggle="modal" data-target="#exampleModalImage" class="outline-none" aria-expanded="false" aria-haspopup="dialog">
  ...
  <div class="fixed antialiased  inset-0 bg-slate-800 bg-opacity-75 flex justify-center items-center opacity-0 pointer-events-none transition-opacity duration-300 ease-out z-[9999]" id="exampleModalImage" aria-hidden="true">
    <div class="bg-white p-4 max-h-[calc(100vh-5rem)] overflow-auto rounded-lg w-10/12 lg:w-8/12 scale-95 transition-transform duration-300 ease-out">
      <div class="pb-0 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/ct-assets/team-4.jpg" alt="alex andrew" class="inline-block object-cover object-center w-11 h-11 rounded-md">
          <div class="flex flex-col">
            <p class="font-sans  text-base text-slate-800 font-semibold">Alex Andrew</p>
            <small class="font-sans  text-sm text-slate-600">@alexandrew</small>
          </div>
        </div>
      ...
      <div class="flex items-end justify-between">
        <div class="flex items-center gap-16">
          <div>
            <small class="font-sans  text-sm text-slate-600">Views</small>
            <p class="font-sans  text-base text-slate-800 font-bold">44,082,044</p>
          </div>
          <div>
            <small class="font-sans  text-sm text-slate-600">Downloads</small>
            <p class="font-sans  text-base text-slate-800 font-bold">553,031</p>
          </div>
        </div>
