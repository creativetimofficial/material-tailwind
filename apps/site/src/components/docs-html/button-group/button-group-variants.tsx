export default function ButtonGroupVariants() {
  ...
  <div class="inline-flex flex-row">
    <button class="inline-flex rounded-md border border-transparent bg-transparent px-3.5 py-2.5 text-center font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:border-slate-800/5 hover:bg-slate-800/5 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none">
      React
    </button>
    <button class="inline-flex rounded-md border border-transparent bg-transparent px-3.5 py-2.5 text-center font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:border-slate-800/5 hover:bg-slate-800/5 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none">
      Vue
  ...
  <div class="inline-flex flex-row">
    <button class="inline-flex rounded-md rounded-r-none border border-slate-800 bg-transparent px-3.5 py-2.5 text-center font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:bg-slate-800 hover:text-slate-50 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none">
      React
    </button>
    ...
    <button class="inline-flex rounded-md rounded-l-none border border-l-0 border-slate-800 bg-transparent px-3.5 py-2.5 text-center font-sans text-sm font-medium leading-none text-slate-800 transition-all duration-300 ease-in hover:bg-slate-800 hover:text-slate-50 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none">
      Svelte
    </button>
  </div>
  <div class="inline-flex flex-row">
