    ...
    <div className="flex w-full flex-col gap-4">
      <div className="inline-flex w-full flex-row">
        <button
          ...
          className="inline-flex w-full select-none items-center justify-center rounded-md rounded-r-none border border-transparent bg-transparent px-3.5 py-2.5 text-center align-middle font-sans text-sm font-medium leading-none text-primary transition-all duration-300 ease-in hover:border-primary/5 hover:bg-primary/5 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
        >
          React
        </button>
        <button
          data-ripple-dark="true"
          className="inline-flex w-full select-none items-center justify-center rounded-none border border-l-0 border-transparent bg-transparent px-3.5 py-2.5 text-center align-middle font-sans text-sm font-medium leading-none text-primary transition-all duration-300 ease-in hover:border-primary/5 hover:bg-primary/5 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
        >
          Vue
        </button>
        <button
          data-ripple-dark="true"
          className="inline-flex w-full select-none items-center justify-center rounded-md rounded-l-none border border-l-0 border-transparent bg-transparent px-3.5 py-2.5 text-center align-middle font-sans text-sm font-medium leading-none text-primary transition-all duration-300 ease-in hover:border-primary/5 hover:bg-primary/5 disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
        >
          Svelte
        </button>
      </div>
