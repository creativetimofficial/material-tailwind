...
export default function AlertWithContent() {
  ...
  <div class="m-1.5 mt-0.5 w-full font-sans text-base leading-none">
    ...
    <p class="font-sans text-base text-current antialiased">I don&#x27;t know what that word means. I&#x27;m happy. But success, that goes back to what in somebody&#x27;s eyes success means. For me, success is inner peace. That&#x27;s a good day for me.</p>
  </div><button id="content-close-trigger" class="outline-none"><svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="m-1 h-5 w-5 stroke-2">
