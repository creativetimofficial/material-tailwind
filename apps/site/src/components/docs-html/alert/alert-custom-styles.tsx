export function AlertCustomStyles() {
  return (
    <div
      role="alert"
      className="relative flex w-full items-start rounded-none border border-b-0 border-l-4 border-r-0 border-t-0 border-green-500 bg-green-500/10 p-2 font-medium text-green-500"
    >
