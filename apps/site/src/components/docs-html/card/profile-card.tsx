...
export default function ProfileCard() {
  ...
  <div class="h-max w-full rounded px-3 py-2 text-center">
    <h5 class="font-sans text-lg font-bold text-current antialiased md:text-xl lg:text-2xl">
      Alex Andrew
    </h5>
  ...
  <div class="w-full px-3.5 pt-2 pb-3.5 rounded flex items-center justify-center gap-1">
    ...
    <button class="group inline-grid min-h-[34px] min-w-[34px] place-items-center rounded-md border border-transparent bg-transparent text-center font-sans text-sm font-medium text-slate-800 outline-none transition-all duration-300 ease-in hover:border-slate-800/5 hover:bg-slate-800/5 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
      <svg class="h-4 w-4" width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
