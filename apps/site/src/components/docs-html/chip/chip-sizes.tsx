...
export default function ChipSizes() {
  return (
    ...
    <div data-shape="pill" class="relative inline-flex w-max items-center border select-none font-sans font-medium rounded-md data-[shape=pill]:rounded-full text-xs p-0.5 shadow-sm bg-slate-800 border-slate-800 text-slate-50">
    ...
    <div data-shape="pill" class="relative inline-flex w-max items-center border select-none font-sans font-medium rounded-md data-[shape=pill]:rounded-full text-sm p-1 shadow-sm bg-slate-800 border-slate-800 text-slate-50">
