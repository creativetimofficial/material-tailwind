    ...
    <div className="w-72 space-y-6">
      <div className="relative w-full rounded-md text-sm leading-none">
        <input
          ...
          className="peer h-full w-full select-none rounded-[inherit] border border-error bg-transparent px-2.5 py-[8.5px] leading-[inherit] text-black outline-none ring ring-transparent transition-all duration-300 ease-in placeholder:text-foreground/60 hover:border-error hover:ring-error/10 focus:border-error focus:outline-none focus:ring-error/10 dark:text-white"
          type="text"
        />
      ...
      <div className="relative w-full rounded-md text-sm leading-none">
        <input
          ...
          className="peer h-full w-full select-none rounded-[inherit] border border-success bg-transparent px-2.5 py-[8.5px] leading-[inherit] text-black outline-none ring ring-transparent transition-all duration-300 ease-in placeholder:text-foreground/60 hover:border-success hover:ring-success/10 focus:border-success focus:outline-none focus:ring-success/10 dark:text-white"
          type="text"
        />
