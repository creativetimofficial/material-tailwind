...
export default function InputCustomStyles() {
  ...
  <div class="relative w-full">
    <input type="text" class="w-full aria-disabled:cursor-not-allowed outline-none focus:outline-none text-slate-800 dark:text-white placeholder:text-slate-600/60 bg-transparent ring-transparent transition-all duration-300 ease-in disabled:opacity-50 disabled:pointer-events-none data-[error=true]:border-red-500 data-[success=true]:border-green-500 text-sm py-2 px-2.5 data-[icon-placement=start]:ps-9 data-[icon-placement=end]:pe-9 hover:ring-slate-800/10 focus:ring-slate-800/10 rounded-none border-0 border-b border-gray-400 pr-0.5 shadow-none ring-0 hover:border-gray-900 focus:border-gray-900 data-[icon-placement=start]:!pl-[26px] dark:border-gray-600 dark:hover:border-gray-50 dark:focus:border-gray-50 peer" data-error="false" data-success="false" data-icon-placement="start" placeholder="Username" />
