...
export default function BreadcrumbWithIcon() {
  return (
    ...
    <a href="/" class="inline-flex items-center gap-1.5 text-sm text-slate-800 transition-colors duration-300 ease-in hover:text-slate-800 dark:text-white dark:hover:text-primary">
    ...
    <a href="#" class="inline-flex items-center gap-1.5 text-sm text-slate-800 transition-colors duration-300 ease-in hover:text-slate-800 dark:text-white dark:hover:text-primary">Components</a>
    <span class="inline-block mx-1 text-sm text-slate-800 opacity-50 pointer-events-none select-none dark:text-white">/</span>
    <a href="#" class="inline-flex items-center gap-1.5 text-sm text-slate-800 transition-colors duration-300 ease-in hover:text-slate-800 dark:text-white dark:hover:text-primary">Breadcrumb</a>
</nav>
`
      }}
    />
