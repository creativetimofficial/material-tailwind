export function BreadcrumbCustomStyles() {
  return (
    <nav className="flex flex-wrap items-center gap-0.5 p-1">
      <a
        href="#"
        className="inline-flex items-center gap-1.5 rounded bg-secondary px-2 py-1 text-sm text-secondary-foreground transition-colors duration-300 ease-in hover:bg-primary hover:text-primary-foreground dark:text-white dark:hover:text-primary"
      >
        <svg
          width="1.5em"
          height="1.5em"
      ...
      <a
        href="#"
        className="inline-flex items-center gap-1.5 rounded bg-primary px-2 py-1 text-sm text-primary-foreground transition-colors duration-300 ease-in hover:bg-primary hover:text-primary-foreground dark:text-white dark:hover:text-primary"
      >
        <svg
          width="1.5em"
          height="1.5em"
