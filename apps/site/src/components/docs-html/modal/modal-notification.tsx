...
<div class="flex justify-center">
  <button type="button" data-dui-toggle="modal" data-dui-target="#exampleModalNotification" class="inline-flex items-center justify-center border align-middle select-none font-sans font-medium text-center duration-300 ease-in disabled:opacity-50 disabled:shadow-none disabled:cursor-not-allowed focus:shadow-none text-sm py-2 px-4 shadow-sm hover:shadow-md bg-stone-800 hover:bg-stone-700 relative bg-gradient-to-b from-stone-700 to-stone-800 border-stone-900 text-stone-50 rounded-lg hover:bg-gradient-to-b hover:from-stone-800 hover:to-stone-800 hover:border-stone-900 after:absolute after:inset-0 after:rounded-[inherit] after:box-shadow after:shadow-[inset_0_1px_0px_rgba(255,255,255,0.25),inset_0_-2px_0px_rgba(0,0,0,0.35)] after:pointer-events-none transition antialiased"> Open </button>
  <div class="fixed antialiased inset-0 bg-stone-800 bg-opacity-75 flex justify-center items-center opacity-0 pointer-events-none transition-opacity duration-300 ease-out z-[9999]" id="exampleModalNotification" aria-hidden="true">
    <div class="bg-white rounded-lg w-9/12 sm:w-7/12 md:w-5/12 lg:w-3/12 scale-95 transition-transform duration-300 ease-out">
      <div class="flex flex-col items-center p-4">
        <h1 class="text-lg text-stone-800 font-semibold">Your Attention is Required!</h1>
        <p class="font-sans text-base text-stone-500">Choose which card you want to connect</p>
      </div>
      <button type="button" data-dui-dismiss="modal" aria-label="Close" class="text-stone-500 hover:text-stone-800 absolute right-3 top-1">&times;</button>
      <div class="p-4 text-stone-500 text-center">
        <svg width="1.5em" height="1.5em" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor" class="mb-6 h-24 w-24 mx-auto text-stone-800">
        ...
        <h6 class="font-sans font-bold text-base md:text-lg lg:text-xl text-inherit">You should read this!</h6>
        <p class="font-sans text-base mt-2 text-center text-stone-500">Many people limit themselves by their own self-doubt, slowing their progress. Fortunately, I was raised with the belief that I could achieve anything.</p>
      </div>
