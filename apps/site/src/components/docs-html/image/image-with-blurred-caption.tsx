  ...
  return (
    <div
      dangerouslySetInnerHTML={{
        __html: `<figure class="relative h-96 w-full">
    <img src="https://images.unsplash.com/photo-1682407186023-12c70a4a35e0?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2832&amp;q=80"  alt="nature-image" class="h-full w-full rounded-xl object-cover object-center" />
