          ...
          <thead className="border-b border-surface bg-surface-light text-sm font-medium text-foreground dark:bg-surface-dark">
            <tr>
              <th className="cursor-pointer px-2.5 py-2 text-start font-medium">
                <small className="flex items-center justify-between gap-2 font-sans text-sm text-inherit antialiased opacity-70">
                  Member{" "}
                  <svg
                    width="1.5em"
                    height="1.5em"
            ...
            <tr className="border-b border-surface last:border-0">
              ...
              <td className="p-3">
                <div className="w-max">
                  <div
                    data-open="true"
                    className="relative inline-flex select-none items-center rounded-full border border-success bg-success p-0.5 font-sans text-xs font-medium leading-none text-success-foreground"
                  >
                    <span className="font-inherit mx-1.5 my-0.5 leading-none text-inherit">
                      Online
                    </span>
              ...
              <td className="p-3">
                <div className="flex items-center gap-3">
                  <img
                    ...
                    alt="Richard Gran"
                    className="inline-block h-8 w-8 rounded object-cover object-center data-[shape=circular]:rounded-full"
                    data-shape="circular"
                  />
                  <div className="flex flex-col">
                    <small className="font-sans text-sm text-inherit antialiased">
