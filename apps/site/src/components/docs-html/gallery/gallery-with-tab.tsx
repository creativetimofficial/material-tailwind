...
export default function GalleryWithTab() {
  return (
    ...
    <div role="tablist" class="flex w-full shrink-0 flex-row rounded-md bg-slate-100 p-1 dark:bg-surface">
        <button role="tab" class="relative z-[2] inline-flex w-full select-none items-center justify-center px-4 py-1.5 text-center align-middle font-sans font-medium text-slate-800 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-white">HTML</button>
        <button role="tab" class="relative z-[2] inline-flex w-full select-none items-center justify-center px-4 py-1.5 text-center align-middle font-sans font-medium text-slate-800 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-white">React</button>
        <button role="tab" class="relative z-[2] inline-flex w-full select-none items-center justify-center px-4 py-1.5 text-center align-middle font-sans font-medium text-slate-800 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-white">Vue</button>
        <button role="tab" class="relative z-[2] inline-flex w-full select-none items-center justify-center px-4 py-1.5 text-center align-middle font-sans font-medium text-slate-800 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-white">Angular</button>
        <button role="tab" class="relative z-[2] inline-flex w-full select-none items-center justify-center px-4 py-1.5 text-center align-middle font-sans font-medium text-slate-800 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-white">Svelte</button>
        <span class="rounded bg-white shadow-sm shadow-black/10 transition-all duration-300 ease-in"></span>
    </div>
