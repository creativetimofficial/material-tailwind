...
export default function AccordionDisabled() {
  ...
  <div 
    class="flex items-center justify-between w-full py-5 text-left font-medium dark:text-white text-slate-800 cursor-pointer cursor-not-allowed opacity-50"
    data-accordion-toggle
    data-accordion-target="#disabledAccordion1"
    aria-disabled="true"
    aria-expanded="false">
  ...
  <div id="disabledAccordion1" class="overflow-hidden transition-all duration-300 border-b border-slate-200 dark:border-slate-700">
  ...
  <div 
    ...
    data-accordion-toggle
    data-accordion-target="#disabledAccordion2"
    aria-expanded="true">
  ...
  <div id="disabledAccordion2" class="overflow-hidden transition-all duration-300 border-b border-slate-200 dark:border-slate-700">
    <p class="mb-5 text-sm text-slate-600 dark:text-slate-400">Material Tailwind is an open-source crafted in Tailwind CSS. Get Material Tailwind and take advantage of its free components and features that will help you set up your web project quickly.</p>
  </div>
  ...
  <div 
    class="flex items-center justify-between w-full py-5 text-left font-medium dark:text-white text-slate-800 cursor-pointer"
    data-accordion-toggle
    data-accordion-target="#disabledAccordion3"
    aria-expanded="false">
  ...
  <div id="disabledAccordion3" class="overflow-hidden transition-all duration-300 border-b border-slate-200 dark:border-slate-700">
    <p class="mb-5 text-sm text-slate-600 dark:text-slate-400">Material Tailwind is an open-source crafted in Tailwind CSS. Get Material Tailwind and take advantage of its free components and features that will help you set up your web project quickly.</p>
  </div>
</div>`
      }}
