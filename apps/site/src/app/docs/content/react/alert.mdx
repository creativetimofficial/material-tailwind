...
<OldComponentPreview demo={<Alert.AlertDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertVariants />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertColors />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertWithList />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertDismissible />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertCustomCloseIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertWithContent />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Alert.AlertCustomStyles />}>
```tsx
"use client";
