...
<OldComponentPreview demo={<Input.InputDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputSizes />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputColors />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputWithValidation />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputWithIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputWithLabel />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputWithHelperText />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputWithButton />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputWithDropdown />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputDisabled />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Input.InputCustomStyles />}>
```tsx
"use client";
