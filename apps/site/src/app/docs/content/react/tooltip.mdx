...
<OldComponentPreview demo={<Tooltip.TooltipDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Tooltip.TooltipPlacement />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Tooltip.TooltipWithHelperIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Tooltip.TooltipCustomStyles />}>
```tsx
"use client";
