---
title: React and Tailwind CSS Swiper - Material Tailwind v3
description: Create responsive carousels with Swiper using React and Tailwind CSS in Material Tailwind v3. Showcase content interactively with customizable swiper components.
github: plugins/swiper
...
<ComponentPreview demo={<Swiper.CarouselDemo />}>
```tsx
import "swiper/css";
