...
<OldComponentPreview demo={<Drawer.DrawerDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Drawer.DrawerPlacement />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Drawer.DrawerWithNavigation />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Drawer.DrawerWithForm />}>
```tsx
"use client";
