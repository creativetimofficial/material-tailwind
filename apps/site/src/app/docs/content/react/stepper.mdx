...
<OldComponentPreview demo={<Stepper.StepperDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Stepper.StepperWithIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Stepper.StepperWithDots />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Stepper.StepperWithContent />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Stepper.StepperCustomStyles />}>
```tsx
"use client";
