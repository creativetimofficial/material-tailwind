...
<OldComponentPreview demo={<Checkbox.CheckboxDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.CheckboxColors />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.CheckboxWithLabel />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.CheckboxWithCustomIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.DisabledCheckbox />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.CheckboxWithLink />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.CheckboxWithDescription />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Checkbox.CustomCheckbox />}>
```tsx
"use client";
