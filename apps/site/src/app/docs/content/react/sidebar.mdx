...
<OldComponentPreview demo={<Sidebar.SidebarDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Sidebar.MultiLevelSidebar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Sidebar.SidebarWithContentSeparator />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Sidebar.SidebarWithCta />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Sidebar.SidebarWithLogo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Sidebar.SidebarWithSearch />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Sidebar.SidebarWithBurgerMenu />}>
```tsx
"use client";
