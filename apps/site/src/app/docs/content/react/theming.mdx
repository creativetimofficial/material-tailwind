...
Check the <Link href="/docs/react/fonts">Fonts Documentation</Link> for more details.
...
Check the <Link href="/docs/react/colors#light-mode-color-palette">Colors Documentation</Link> for more details.
...
Check the <Link href="/docs/react/colors#dark-mode-color-palette">Colors Documentation</Link> for more details.
...
For the font we'll use the `DM Serif Display` for titles and `Lato` for the body. Check the <Link href="/docs/react/fonts">Fonts Documentation</Link> on how to add new fonts to your project.
