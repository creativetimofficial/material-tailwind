...
<OldComponentPreview demo={<Navbar.NavbarDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Navbar.StickyNavbar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Navbar.ComplexNavbar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Navbar.NavbarWithSearch />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Navbar.DarkNavbar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Navbar.SimpleNavbar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Navbar.NavbarWithMegaMenu />}>
```tsx
"use client";
