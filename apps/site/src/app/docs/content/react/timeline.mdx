...
<OldComponentPreview demo={<Timeline.TimelineDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Timeline.TimelineWithIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Timeline.TimelineWithAvatar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Timeline.ActivitiesTimeline />}>
```tsx
"use client";
