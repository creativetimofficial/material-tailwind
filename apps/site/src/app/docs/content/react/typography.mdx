...
<OldComponentPreview demo={<Typography.Headings />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Typography.Paragraph />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Typography.LeadParagraph />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Typography.SmallText />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Typography.TypographyColors />}>
```tsx
"use client";
