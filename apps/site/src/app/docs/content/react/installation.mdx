...
>
  <FrameworkCard name="Next.js" route="/docs/react/guide/next">
    <Icons.NextLogo className="w-24 h-24" />
  </FrameworkCard>
  <FrameworkCard name="Remix" route="/docs/react/guide/remix">
    <Icons.RemixLogo className="w-24 h-24" />
  </FrameworkCard>
  <FrameworkCard name="Astro" route="/docs/react/guide/astro">
    <Icons.AstroLogo className="w-20 h-20" />
  </FrameworkCard>
  <FrameworkCard name="Vite" route="/docs/react/guide/vite">
    <Icons.ViteLogo className="w-24 h-24" />
  </FrameworkCard>
  <FrameworkCard name="Gatsby" route="/docs/react/guide/gatsby">
    <Icons.GatsbyLogo className="w-20 h-20" />
  </FrameworkCard>
  <FrameworkCard name="Create React App" route="/docs/react/guide/cra">
