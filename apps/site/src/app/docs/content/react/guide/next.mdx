...
## Setup Tailwind CSS v4 (Recommended)

If you want to use the latest Tailwind CSS v4 with improved performance and new features, you can set it up manually:
...
Update your `postcss.config.js` file to use the new Tailwind CSS v4 PostCSS plugin:
...
Replace the Tailwind directives in your `./app/globals.css` file with the new v4 import:
