...
The `<Carousel />` component is removed, instead we added a complete integration of <Link href="https://swiperjs.com/" target="_blank">Swiper</Link> with Material Tailwind, check the <Link href="/docs/react/plugins/swiper">integration here</Link>.

### Navbar

The `<Navbar />` component is removed, instead you can use `<Card />` with `<Collapse />` components to create a navbar, check the <Link href="/docs/react/navbar">Navbar Documentation</Link>.

### Speed Dial

The `<SpeedDial />` component is removed, instead you can use `<Tooltip />` with `<IconButton />` components to create a similar effect, check the <Link href="/docs/react/plugins/swiper">Speed Dial Documentation</Link>.

### Stepper

The `<Stepper />` component is removed, instead you can use `<Timeline />` component to create a similar effect, check the <Link href="/docs/react/plugins/stepper">Stepper Documentation</Link>.
...
For more information about the `<Accordion />` component, check the <Link href="/docs/react/accordion">Accordion Documentation</Link>.
...
For more information about the `<Alert />` component, check the <Link href="/docs/react/alert">Alert Documentation</Link>.
...
For more information about the `<Breadcrumb />` component, check the <Link href="/docs/react/breadcrumb">Breadcrumb Documentation</Link>.
...
For more information about the `<Checkbox />` component, check the <Link href="/docs/react/checkbox">Checkbox Documentation</Link>.
...
For more information about the `<Chip />` component, check the <Link href="/docs/react/chip">Chip Documentation</Link>.
...
For more information about the `<Dialog />` component, check the <Link href="/docs/react/dialog">Dialog Documentation</Link>.
...
For more information about the `<Drawer />` component, check the <Link href="/docs/react/drawer">Drawer Documentation</Link>.
...
For more information about the `<Input />` component, check the <Link href="/docs/react/input">Input Documentation</Link>.
...
For more information about the `<Progress />` component, check the <Link href="/docs/react/progress">Progress Bar Documentation</Link>.
...
For more information about the `<Radio />` component, check the <Link href="/docs/react/radio">Radio Documentation</Link>.
...
For more information about the `<Select />` component, check the <Link href="/docs/react/select">Select Documentation</Link>.
...
For more information about the `<Tabs />` component, check the <Link href="/docs/react/tabs">Tabs Documentation</Link>.
...
For more information about the `<Timeline />` component, check the <Link href="/docs/react/timeline">Timeline Documentation</Link>.
...
For more information about the `<Tooltip />` component, check the <Link href="/docs/react/tooltip">Tooltip Documentation</Link>.
