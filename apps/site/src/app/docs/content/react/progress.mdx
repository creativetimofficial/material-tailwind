...
<OldComponentPreview demo={<Progress.ProgressDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Progress.ProgressSizes />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Progress.ProgressColors />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Progress.ProgressLabelInside />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Progress.ProgressLabelOutside />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Progress.ProgressCustomStyles />}>
```tsx
"use client";
