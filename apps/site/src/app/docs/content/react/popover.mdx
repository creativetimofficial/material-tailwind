...
<OldComponentPreview demo={<Popover.PopoverDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Popover.PopoverPlacement />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Popover.SubscriptionPopover />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Popover.ContactPopover />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Popover.PopoverWithImage />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Popover.ProfileInfoPopover />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Popover.PopoverWithDescription />}>
```tsx
"use client";
