...
<OldComponentPreview demo={<Chip.ChipDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipSizes />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipVariants />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipColors />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipIcon />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipDismissible />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipWithAvatar />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Chip.ChipRounded />}>
```tsx
"use client";
