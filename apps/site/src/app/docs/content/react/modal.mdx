...
<OldComponentPreview demo={<Dialog.DialogDemo />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogSizes />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogWithForm />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogWithImage />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogWeb3 />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogLong />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogMessage />}>
```tsx
"use client";
...
<OldComponentPreview demo={<Dialog.DialogNotification />}>
```tsx
"use client";
