...
<OldComponentPreview demo={<HTMLGallery.GalleryDemo />}>
```html
...
<OldComponentPreview demo={<HTMLGallery.MasonryGridGallery />}>
```html
...
<OldComponentPreview demo={<HTMLGallery.FeaturedImageGallery />}>
```html
<div class="grid gap-4">
  <div>
    <img
...
<OldComponentPreview demo={<HTMLGallery.QuadGallery />}>
```html
...
<OldComponentPreview demo={<HTMLGallery.GalleryWithTab />}>
```html
