...
<ComponentPreview demo={<HTMLPagination.PaginationDemo />}>
```html
...
<ComponentPreview demo={<HTMLPagination.PaginationCircular />}>
```html
<div class="flex items-center gap-1">
...
<ComponentPreview demo={<HTMLPagination.SimplePagination />}>
```html
...
<ComponentPreview demo={<HTMLPagination.PaginationGroup />}>
```html
...
<p class="mt-4 antialiased text-foreground">The "Previous" and "Next" buttons include SVG icons indicating navigation direction. These icons are centered within the buttons using absolute positioning and transformation utilities.</p>
