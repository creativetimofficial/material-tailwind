...
<ComponentPreview demo={<HTMLFooter.FooterDemo />}>
```html
...
<ComponentPreview demo={<HTMLFooter.FooterWithLogo />}>
```html
<footer class="w-full">
  <div class="flex flex-row flex-wrap items-center justify-center w-full text-center gap-x-12 gap-y-3 md:justify-between">
    <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/ct-assets/logo.png" alt="brand" class="w-8" />
    <ul class="flex flex-wrap items-center gap-x-6 gap-y-2">
      <li>
        <a
          href="#"
...
<ComponentPreview demo={<HTMLFooter.FooterWithSocialLinks />}>
```html
...
<ComponentPreview demo={<HTMLFooter.FooterWithSitemap />}>
```html
<footer class="relative w-full">
  <div class="w-full px-8 mx-auto max-w-7xl">
