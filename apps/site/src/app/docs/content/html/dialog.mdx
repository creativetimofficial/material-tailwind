...
The dialog component requires a script for handling open/close states, backdrop clicks, and keyboard interactions. Add this script to your HTML file for proper functionality.
