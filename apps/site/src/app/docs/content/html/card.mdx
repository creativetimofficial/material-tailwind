...
<div class="w-full max-w-[24rem] overflow-hidden rounded-lg border border-surface bg-background shadow-lg shadow-black/5">
  ...
  <div class="mt-4 flex w-full items-center justify-between rounded px-3 pb-3 pt-1.5">
    <div class="flex items-center -space-x-3">
      <button class="outline-hidden group">
        <img
...
```html
<div class="relative flex h-160 w-full max-w-md flex-col items-end justify-center overflow-hidden rounded-lg border border-surface bg-background text-center shadow-lg shadow-black/5">
  <div class="m-1.5 h-max w-[calc(100%-12px)] rounded-[5px]">
    <div class="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('https://images.unsplash.com/photo-1552960562-daf630e9278b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80')] bg-cover bg-center">
      <div class="absolute inset-0 h-full w-full bg-linear-to-t from-black/80 via-black/50 to-black/10 dark:from-black/90 dark:via-black/60 dark:to-black/20"></div>
    </div>
  </div>
...
```html
<div class="w-full max-w-104 overflow-hidden rounded-lg border border-surface bg-background shadow-lg shadow-black/5">
  <div class="relative m-1.5 h-max w-[calc(100%-12px)] overflow-hidden rounded-[5px] p-0">
    <img
      src="https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1470&amp;q=80"
      alt="ui/ux review check"
    />
    <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-linear-to-tr from-transparent via-transparent to-black/60 "></div>
...
```html
<div class="w-full max-w-104 overflow-hidden rounded-lg border border-none border-surface bg-background shadow-none shadow-black/5">
...
```html
<div class="flex h-full w-full max-w-3xl flex-row overflow-hidden rounded-lg border border-surface bg-background shadow-lg shadow-black/5">
