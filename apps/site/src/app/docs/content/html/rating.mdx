...
<ComponentPreview demo={<HTMLRating.RatingDemo />}>
```html
...
<ComponentPreview demo={<HTMLRating.RatingColors />}>
```html
...
<ComponentPreview demo={<HTMLRating.ReadonlyRating />}>
```html
<div class="inline-flex items-center text-primary">
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
<ComponentPreview demo={<HTMLRating.CustomRatingIcon />}>
```html
<div class="inline-flex items-center text-primary">
  <svg
    width="1.5em"
...
<ComponentPreview demo={<HTMLRating.RatingWithText />}>
```html
...
<ComponentPreview demo={<HTMLRating.RatingWithComment />}>
```html
