...
<OldComponentPreview demo={<HTMLButtonGroup.ButtonGroupDemo />}>
```html
...
<OldComponentPreview demo={<HTMLButtonGroup.ButtonGroupVariants />}>
```html
...
<OldComponentPreview demo={<HTMLButtonGroup.ButtonGroupSizes />}>
```html
...
<OldComponentPreview demo={<HTMLButtonGroup.ButtonGroupColors />}>
```html
<div class="flex flex-col gap-4">
  <div class="inline-flex flex-row">
    <button
...
<OldComponentPreview demo={<HTMLButtonGroup.ButtonGroupWithIcon />}>
```html
<div className="flex flex-col gap-4">
  <div className="inline-flex flex-row ">
    <button
...
<OldComponentPreview demo={<HTMLButtonGroup.BlockLevelButtonGroup />}>
```html
...
<OldComponentPreview demo={<HTMLButtonGroup.PillButtonGroup />}>
```html
<div class="flex flex-col gap-4">
  <div class="inline-flex flex-row">
    <button
...
<OldComponentPreview demo={<HTMLButtonGroup.CustomButtonGroup />}>
```html
<div class="inline-flex flex-row">
  <button
    data-ripple-light="true"
