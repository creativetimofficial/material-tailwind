...
<div class="space-y-4 w-72">
  ...
  <div class="relative w-full text-base leading-none rounded-lg">
    <input
...
On focus, the border of each input thickens (`focus:border-2`) and changes color to match their respective themes, while the top border remains transparent (`border-t-transparent`).
