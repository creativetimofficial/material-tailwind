...
<OldComponentPreview demo={<HTMLInput.InputDemo />}>
```html
<input
  placeholder="Input"
...
<OldComponentPreview demo={<HTMLInput.InputSizes />}>
```html
 <div className="flex flex-col gap-4">
  ...
  <input
    ...
    className="w-72 select-none rounded-md border border-surface bg-transparent px-3.5 py-[12.25px] text-base leading-none text-black outline-none ring-4 ring-transparent transition-all duration-300 ease-in placeholder:text-foreground/60 hover:border-primary hover:ring-primary/10 focus:border-primary focus:outline-none focus:ring-primary/10 dark:text-white"
    type="text"
  />
</div>
```
...
<OldComponentPreview demo={<HTMLInput.InputColors />}>
```html
<div className="flex flex-col gap-4">
  <input
...
<OldComponentPreview demo={<HTMLInput.InputWithValidation />}>
```html
...
<OldComponentPreview demo={<HTMLInput.InputWithIcon />}>
```html
...
<OldComponentPreview demo={<HTMLInput.InputWithLabel />}>
```html
...
<OldComponentPreview demo={<HTMLInput.InputWithHelperText />}>
```html
...
<OldComponentPreview demo={<HTMLInput.InputWithButton />}>
```html
<form
  action="#"
...
<OldComponentPreview demo={<HTMLInput.InputWithDropdown />}>
```html
<div class="relative flex w-full max-w-[24rem]">
  <button
    id=":rk:"
    class="group flex h-10 select-none items-center justify-center gap-2 rounded-md rounded-r-none border border-r-0 border-surface bg-secondary px-3.5 py-2.5 pl-3 text-center align-middle font-sans text-sm font-medium leading-none text-secondary-foreground outline-none transition-all duration-300 ease-in hover:border-secondary-light hover:bg-secondary-light disabled:cursor-not-allowed disabled:opacity-50 disabled:shadow-none"
  >
    <img
...
<OldComponentPreview demo={<HTMLInput.InputDisabled />}>
```html
<div
