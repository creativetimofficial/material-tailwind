...
The collapse component requires a script for handling expand/collapse states and animations. Add this script to your HTML file for proper functionality.
