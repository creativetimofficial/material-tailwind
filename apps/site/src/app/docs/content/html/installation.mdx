...
### Types Not Found
If you see the error make sure your `tsconfig.json` has `"moduleResolution": "node"`. Other resolution strategies like "bundler" or "nodeNext" might not resolve the types correctly.
