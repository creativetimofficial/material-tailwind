...
var Button = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  var children = _ref.children,
      ...
      ripple = _ref.ripple,
      rest = _objectWithoutProperties(_ref, ["children", "color", "buttonType", "size", "rounded", "iconOnly", "ripple"]);

  var rippleEffect = new _materialRippleEffects["default"]();
  var classes = [];
  rounded = rounded ? "rounded-full" : "rounded-lg";
  var sharedClasses = ["flex", "items-center", "gap-1", "font-bold", "outline-none", "uppercase", "tracking-wider", "focus:outline-none", "focus:shadow-none", "transition-all", "duration-300", rounded];
  var buttonFilled = [filledBgColors[color], filledBgHoverColors[color], filledBgFocusColors[color], filledBgActiveColors[color], "text-white", "shadow-md", "hover:shadow-xl"];
