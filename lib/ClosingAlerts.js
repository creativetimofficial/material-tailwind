...
function ClosingAlerts(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, showAlert ? /*#__PURE__*/_react.default.createElement("div", _extends({}, rest, {
    className: "flex items-center gap-3 text-white p-4 pr-12 border-0 rounded relative mb-4 ".concat(colors[color], " transition-all duration-300")
