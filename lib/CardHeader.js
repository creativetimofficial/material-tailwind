...
function CardHeader(_ref) {
  var children = _ref.children,
      ...
      contentPosition = _ref$contentPosition === void 0 ? 'center' : _ref$contentPosition,
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: "bg-gradient-to-tr ".concat(fromColors[color], " ").concat(toColors[color], " -mt-10 mb-6 rounded-xl text-white grid items-center ").concat(headerSize, " ").concat(shadowColors[color])
  }, children);
}
...
CardHeader.propTypes = {
  ...
  contentPositin: _propTypes["default"].string
};