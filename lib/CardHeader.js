...
function CardHeader(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: "bg-gradient-to-tr ".concat(fromColors[color], " ").concat(toColors[color], " -mt-10 mb-6 rounded-xl text-white grid items-center ").concat(headerSize, " ").concat(shadowColors[color], " ").concat(className)
  }, children);
}
