...
function Dropdowns(_ref) {
  var children = _ref.children,
      ...
      rest = _objectWithoutProperties(_ref, ["children", "buttonText", "color", "buttonType", "size", "placement", "rounded"]);

  var _React$useState = _react.default.useState(false),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      dropdownShow = _React$useState2[0],
      setDropdownShow = _React$useState2[1]; // Styles


  var classes = [];
  rounded = rounded ? 'rounded-full' : 'rounded';
  var sharedClasses = ['flex', 'items-center', 'gap-1', 'rounded-lg', 'font-bold', 'outline-none', 'uppercase', 'tracking-wider', 'focus:outline-none', 'transition-all', 'duration-300', rounded];
  var buttonFilled = ['text-white', 'shadow-md', 'hover:shadow-xl', filledBgColors[color], "hover:".concat(filledBgHoverColors[color]), "focus:".concat(filledBgFocusColors[color]), "active:".concat(filledBgActiveColors[color])];
  ...
  var buttonSM = [].concat(sharedClasses, ['py-1.5 pl-5 pr-3', 'text-xs', 'leading-normal']);
  var buttonRegular = [].concat(sharedClasses, ['p-2.5 pl-7 pr-5', 'text-xs', 'leading-normal']);
  var buttonLG = [].concat(sharedClasses, ['py-3 pl-8 pr-6', 'text-sm', 'leading-relaxed']);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_react2.default, {
    ...
    className: "material-icons text-lg align-middle"
