...
function DropdownItem(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("a", _extends({}, rest, {
    className: "text-sm py-3 px-4 font-normal block cursor-pointer whitespace-no-wrap rounded-md text-gray-900 hover:text-white ".concat(Colors[color], " ").concat(ShadowColors[color], " transition-all duration-300"),
