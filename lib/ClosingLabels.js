...
function ClosingLabels(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, showLabel ? /*#__PURE__*/_react.default.createElement("div", {
    className: "max-w-max flex items-center justify-between py-1 pl-3 pr-1 rounded-full ".concat(divBgColors[color], " last:mr-0 mr-1 transition-all duration-300")
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "text-xs font-semibold uppercase ".concat(textColors[color], " uppercase mr-2")
  }, children), /*#__PURE__*/_react.default.createElement("span", {
    className: "".concat(spanBgColors[color], " text-white text-sm leading-none rounded-full w-4 h-4 cursor-pointer p-1 pt-0.5"),
    onClick: closeLabel
  }, "\xD7")) : null);
}
