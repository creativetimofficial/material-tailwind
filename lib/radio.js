...
function Radio(_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    id: id,
    type: "radio",
    "class": "mt-radio ".concat(colors[color], " hidden overflow-hidden")
  })), /*#__PURE__*/_react["default"].createElement("label", {
    "for": id,
    "class": "flex items-center cursor-pointer text-gray-400 select-none transition-all duration-300"
  }, /*#__PURE__*/_react["default"].createElement("span", {
    "class": "relative w-4 h-4 inline-block mr-2 rounded-full border border-gray-500 transition-all duration-300"
  }), text));
}
