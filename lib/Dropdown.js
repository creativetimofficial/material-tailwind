...
function Dropdown(_ref) {
  var children = _ref.children,
      ...
      block = _ref.block,
      ripple = _ref.ripple,
      rest = _objectWithoutProperties(_ref, ["children", "buttonText", "color", "buttonType", "size", "placement", "rounded", "block", "ripple"]);
  ...
  var sharedClasses = [block && 'w-full', 'flex', 'items-center', 'justify-center', 'gap-1', 'rounded-lg', 'font-bold', 'outline-none', 'uppercase', 'tracking-wider', 'focus:outline-none', 'transition-all', 'duration-300', rounded];
