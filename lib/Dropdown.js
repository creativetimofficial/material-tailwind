...
function Dropdown(_ref) {
  ...
  var buttonFilled = ["text-white", "shadow-md", "hover:shadow-xl", filledBgColors[color], filledBgHoverColors[color], filledBgFocusColors[color], filledBgActiveColors[color]];
