...
interface ButtonGroupProps extends BaseComponent<"div"> {
    ripple?: boolean;
    rounded?: boolean;
    fullWidth?: boolean;
    className?: string;
