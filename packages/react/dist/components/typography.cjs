...
var Typography = import_react2.default.forwardRef(
  ({ as, color, variant, isGradient, className, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Element, { ...rest, ref, className: styles, children });
  }
);
