...
var ButtonGroup = import_react2.default.forwardRef(
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ...rest, ref, className: styles, children: import_react2.default.Children.map(
      children,
      (child) => import_react2.default.isValidElement(child) && import_react2.default.cloneElement(child, {
        variant,
        size,
        color,
        ripple,
...
var button_group_default2 = ButtonGroup;
