...
export const iconButtonTheme = {
  ...
  size: {
    xs: "text-sm min-w-[30px] min-h-[30px] rounded-md shadow-xs hover:shadow-sm",
    sm: "text-sm min-w-[34px] min-h-[34px] rounded-md shadow-xs hover:shadow-sm",
    md: "text-sm min-w-[38px] min-h-[38px] rounded-md shadow-xs hover:shadow-md",
    lg: "text-base min-w-[46px] min-h-[46px] rounded-md shadow-xs hover:shadow-lg",
    xl: "text-base min-w-[50px] min-h-[50px] rounded-lg shadow-xs hover:shadow-lg",
  },
