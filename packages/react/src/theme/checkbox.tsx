...
export const checkboxTheme = {
  ...
  inputStyle:
    "peer h-full w-full appearance-none rounded bg-secondary-dark transition-all duration-200 ease-in disabled:opacity-50 disabled:pointer-events-none dark:bg-secondary-dm-main",
  inputColor: {
