...
export const radioTheme = {
  ...
  inputStyle:
    "peer h-full w-full appearance-none rounded-full border border-gray-400 transition-all duration-300 ease-in disabled:opacity-50 disabled:pointer-events-none dark:border-gray-600",
  inputColor: {
    primary:
