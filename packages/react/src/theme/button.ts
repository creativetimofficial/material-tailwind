...
export const buttonTheme = {
  ...
  variant: {
    ...
    solid: {
      primary:
        "bg-primary-main border-primary-dark text-primary-content hover:bg-primary-light focus:bg-primary-light dark:bg-primary-dm-main dark:border-primary-dm-dark dark:text-primary-dm-content dark:hover:bg-primary-dm-light hover:focus:bg-primary-dm-light",
      secondary:
