...
export const dialogContentTheme = {
  ...
  baseStyle:
    "fixed z-[9998] top-1/2 left-1/2 -translate-x-1/2 px-4 py-3 -translate-y-1/2 bg-white w-full h-full rounded-xl shadow-2xl shadow-primary-dark/5 border border-secondary-dark",
  size: {
