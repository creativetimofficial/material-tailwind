...
export const inputTheme = {
  ...
  iconStyle:
    "pointer-events-none absolute top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-700 peer-hover:text-secondary-content peer-focus:text-secondary-content transition-all duration-300 ease-in dark:peer-hover:text-secondary-dm-content dark:peer-focus:text-secondary-dm-content",
  startIcon: "left-[7px]",
  endIcon: "right-[7px]",
