const inputOutlinedLabelColors = {
  black: {
    color: "!text-black peer-focus:text-black peer-disabled:text-black/50",
    before: "before:border-black peer-focus:before:!border-black",
    after: "after:border-black peer-focus:after:!border-black",
  },
  white: {
    color: "!text-white peer-focus:text-white peer-disabled:text-white/50",
    before: "before:border-white peer-focus:before:!border-white",
    after: "after:border-white peer-focus:after:!border-white",
  },
  "blue-gray": {
    color: "text-blue-gray-400 peer-focus:text-blue-gray-500 peer-disabled:text-blue-gray-400/50",
  ...
  gray: {
    color: "text-blue-gray-400 peer-focus:text-gray-500 peer-disabled:text-blue-gray-400/50",
  ...
  brown: {
    color: "text-blue-gray-400 peer-focus:text-brown-500 peer-disabled:text-blue-gray-400/50",
  ...
  "deep-orange": {
    color: "text-blue-gray-400 peer-focus:text-deep-orange-500 peer-disabled:text-blue-gray-400/50",
  ...
  orange: {
    color: "text-blue-gray-400 peer-focus:text-orange-500 peer-disabled:text-blue-gray-400/50",
  ...
  amber: {
    color: "text-blue-gray-400 peer-focus:text-amber-500 peer-disabled:text-blue-gray-400/50",
  ...
  yellow: {
    color: "text-blue-gray-400 peer-focus:text-yellow-500 peer-disabled:text-blue-gray-400/50",
  ...
  lime: {
    color: "text-blue-gray-400 peer-focus:text-lime-500 peer-disabled:text-blue-gray-400/50",
  ...
  "light-green": {
    color: "text-blue-gray-400 peer-focus:text-light-green-500 peer-disabled:text-blue-gray-400/50",
  ...
  green: {
    color: "text-blue-gray-400 peer-focus:text-green-500 peer-disabled:text-blue-gray-400/50",
  ...
  teal: {
    color: "text-blue-gray-400 peer-focus:text-teal-500 peer-disabled:text-blue-gray-400/50",
  ...
  cyan: {
    color: "text-blue-gray-400 peer-focus:text-cyan-500 peer-disabled:text-blue-gray-400/50",
  ...
  "light-blue": {
    color: "text-blue-gray-400 peer-focus:text-light-blue-500 peer-disabled:text-blue-gray-400/50",
  ...
  blue: {
    color: "text-blue-gray-400 peer-focus:text-blue-500 peer-disabled:text-blue-gray-400/50",
  ...
  indigo: {
    color: "text-blue-gray-400 peer-focus:text-indigo-500 peer-disabled:text-blue-gray-400/50",
  ...
  "deep-purple": {
    color: "text-blue-gray-400 peer-focus:text-deep-purple-500 peer-disabled:text-blue-gray-400/50",
  ...
  purple: {
    color: "text-blue-gray-400 peer-focus:text-purple-500 peer-disabled:text-blue-gray-400/50",
  ...
  pink: {
    color: "text-blue-gray-400 peer-focus:text-pink-500 peer-disabled:text-blue-gray-400/50",
  ...
  red: {
    color: "text-blue-gray-400 peer-focus:text-red-500 peer-disabled:text-blue-gray-400/50",
