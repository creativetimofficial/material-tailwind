...
import { propTypesVariant, propTypesSize } from "../../../types/components/select";
...
export interface SelectVariantStylesType {
  ...
  colors: {
    select: Record<string, Record<string, Record<string, string>>>;
    label: Record<string, Record<string, Record<string, string>>>;
  };
    ...
    base: {
      ...
      arrow: {
        initial: {
          ...
          width: "w-5",
          height: "h-5",
          color: "text-blue-gray-400 peer:disabled:text-blue-gray-400/50",
