...
import copyToClipboard from "legacy/utils/copy-to-clipboard";
...
export function CodePreview({ id, component, link, children, className }) {
  ...
  return (
    <div
      id={id}
      className={`border-blue-gray-50 scroll-mt-64 rounded-xl border ${
        mode === "code" ? "bg-[#1e293b]" : "bg-[#f8fafc]"
      } ${className || ""}`}
    >
      <div
        className={`border-blue-gray-50 flex items-center justify-between border-b p-1 ${
