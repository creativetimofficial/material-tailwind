...
2: Once you have created your account make sure that you turn on the **Test Mode** on the top right corner of Stripe dashboard, this will allow you to test the payments without any real transactions.

3:. Then go to the <Code>Developers</Code> on the top right corner, then click on the <Code>API Keys</Code> and copy/paste the **Publishable Key** and **Secret Key** to the **.env** file.
