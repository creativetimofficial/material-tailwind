      ...
      >
        ...
        >
          <div className="flex flex-col gap-4 p-6">
            ...
            <h6 className="-mb-2 block font-sans text-base font-semibold leading-relaxed tracking-normal text-inherit antialiased">
              Your Email
            </h6>
          ...
          <div className="p-6 pt-0">
            ...
            <p className="mt-4 flex justify-center font-sans text-sm font-light leading-normal text-inherit antialiased">
              Don&apos;t have an account?
              <a
                href="#signup"
                className="ml-1 block font-sans text-sm font-bold leading-normal text-blue-gray-900 antialiased"
              >
                Sign up
              </a>
            </p>
