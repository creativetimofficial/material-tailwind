    ...
    <div className="w-full max-w-sm min-w-[200px]">
      <div className="relative">
        ...
        <label
          ...
          className="absolute bg-white px-1 left-9 top-2.5 text-slate-400 text-sm transition-all transform origin-left peer-focus:-top-2 peer-focus:left-10 peer-focus:text-xs peer-focus:text-slate-400 peer-focus:scale-90"
        >
          e.g., +1 123-456-7890
        </label>
      </div>
